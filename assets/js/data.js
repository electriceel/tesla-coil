...
const SEED_VERSION = '2026.09.14.5';
...
const SEED_VEHICLES = [
  ...
  V({ id: 'ford-transit-2015-2023', mk: 'Ford', md: 'Transit / Transit Connect', y0: 2015, y1: 2023,
       ...
       entry: 'Lishi HU101' }),
  V({ id: 'ford-expedition-2015-2024', mk: 'Ford', md: 'Expedition', y0: 2015, y1: 2024, b: 'suv',
  ...
  V({ id: 'chevy-trailblazer-2002-2009', mk: 'Chevrolet', md: 'TrailBlazer / GMC Envoy', y0: 2002, y1: 2009, b: 'suv',
      ...
      sys: 'PK3+', clone: 'Yes', sp: 10, dp: 4, cut: 'Edge cut', dec: 'Lishi GM37',
      obd: 'Yes', on: '30-min x3 relearn', akl: 'Relearn', entry: 'Lishi GM37' }),
  V({ id: 'gmc-acadia-2007-2023', mk: 'GMC', md: 'Acadia', y0: 2007, y1: 2023, b: 'suv',
  ...
  V({ id: 'ford-ranger-2024-2026', mk: 'Ford', md: 'Ranger', y0: 2024, y1: 2026, b: 'truck',
      ...
      entry: 'Lishi HU101' }),
  V({ id: 'ford-expedition-2025-2026', mk: 'Ford', md: 'Expedition', aka: ['Expedition MAX'], y0: 2025, y1: 2026, b: 'suv',
      kw: 'HU101 (emergency blade)', il: 'HU101-PT', chip: 'ID49 / Hitag Pro', sys: 'PATS / BCM', clone: 'No',
      sp: 10, dp: 4, cut: 'Laser / sidewinder', dec: 'Lishi HU101', obd: 'Current Ford-capable tool', on: 'No',
      akl: 'Security access and current tool coverage required',
      note: 'Fifth-generation redesign. The MAX is the long-wheelbase body, not a different key system. Verify the exact fob by VIN.', entry: 'Lishi HU101' }),
  ...
  V({ id: 'nissan-kicks-2025-2026', mk: 'Nissan', md: 'Kicks', y0: 2025, y1: 2026, b: 'suv',
      ...
      note: 'Second-generation Kicks. The carryover 2025 Kicks Play is a different vehicle and key listing; verify VIN and fob style before ordering.',
      entry: 'Emergency blade in the driver door' }),
  V({ id: 'nissan-kicks-play-2025', mk: 'Nissan', md: 'Kicks Play', aka: ['Kicks'], y0: 2025, y1: 2025, b: 'suv',
      kw: 'NSN14 (emergency blade)', il: 'DA34', chip: 'Nissan smart key; verify by VIN', sys: 'NATS', clone: 'No',
      sp: 10, dp: 4, cut: 'Laser / sidewinder', dec: 'Lishi NSN14', obd: 'Current Nissan-capable tool', on: 'No',
      akl: 'OBD plus BCM PIN/security calculation; confirm tool coverage', pin: 'Yes',
      note: 'Carryover first-generation Kicks sold only for 2025. Do not order from the redesigned 2025-2026 Kicks listing.',
      entry: 'Emergency blade in the driver door' }),
  ...
  V({ id: 'chevy-equinox-2025-2026', mk: 'Chevrolet', md: 'Equinox', y0: 2025, y1: 2026, b: 'suv',
      ...
      entry: 'Emergency blade behind the driver-handle cap' }),
  V({ id: 'chevy-traverse-2018-2023', mk: 'Chevrolet', md: 'Traverse', y0: 2018, y1: 2023, b: 'suv',
      ...
      akl: 'OBD plus security relearn',
      entry: 'Lishi HU100' }),
  V({ id: 'chevy-traverse-limited-2024', mk: 'Chevrolet', md: 'Traverse Limited', aka: ['Traverse'], y0: 2024, y1: 2024, b: 'suv',
      kw: 'B119 (emergency blade)', il: 'B119-PT', chip: 'GM 46E / AES by configuration', sys: 'GM passive entry', clone: 'No',
      sp: 10, dp: 4, cut: 'Laser / sidewinder', dec: 'Lishi HU100', obd: 'Yes with a current GM-capable tool', on: 'No',
      akl: 'OBD plus security relearn', note: 'Carryover second-generation body sold beside the redesigned 2024 Traverse; identify the Limited before ordering.',
      entry: 'Lishi HU100' }),
  V({ id: 'chevy-traverse-2024-2026', mk: 'Chevrolet', md: 'Traverse', y0: 2024, y1: 2026, b: 'suv',
      kw: 'B119 (emergency blade)', il: 'B119-PT', chip: 'GM AES', sys: 'GM passive entry / security gateway', clone: 'No',
      sp: 10, dp: 4, cut: 'Laser / sidewinder', dec: 'Lishi HU100', obd: 'Current GM-capable tool', on: 'No',
      akl: 'Confirm aftermarket coverage; SPS/dealer route may be required',
      note: 'Third-generation body and electronics. The 2024 Traverse Limited is the carryover vehicle and uses a different listing.',
      entry: 'Emergency blade behind the driver-handle cap' }),
  V({ id: 'gmc-terrain-2025-2026', mk: 'GMC', md: 'Terrain', y0: 2025, y1: 2026, b: 'suv',
      ...
      entry: 'Emergency blade behind the driver-handle cap' }),
  V({ id: 'gmc-acadia-2024-2026', mk: 'GMC', md: 'Acadia', y0: 2024, y1: 2026, b: 'suv',
      kw: 'B119 (emergency blade)', il: 'B119-PT', chip: 'GM AES', sys: 'GM passive entry / security gateway', clone: 'No',
      sp: 10, dp: 4, cut: 'Laser / sidewinder', dec: 'Lishi HU100', obd: 'Current GM-capable tool', on: 'No',
      akl: 'Confirm aftermarket coverage; SPS/dealer route may be required',
...
const SEED_BLANKS = [
  ...
  /* ---- IMPORT AND UNCOMMON ----
     ...
     genuinely turn up on the Central Coast — Euro profile cylinders on modern
  ...
  { id:'cruciform', cat:'Import & uncommon', keyway:'Cruciform / cross (Zeiss / Elzett / CISA)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Cross — three or four wings', spaces:'', depths:'', makes:['Zeiss','Elzett','CISA','Fiat','Lada'],
  ...
  { id:'brit-lever', cat:'Import & uncommon', keyway:'British lever lock (Chubb / Union / ERA / Legge)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Lever — a bit key, not a pin key', spaces:'', depths:'', makes:['Chubb','Union','ERA','Legge','Yale UK'],
    notes:'Levers rather than pins: a bit key lifts a stack of levers to align a gate. The five-lever BS3621 mortise deadlock is the British standard front-door lock and the thing an insurer requires there. Turns up on imported hardware in high-end homes and on anything shipped from the UK. Nothing in a US pin kit applies — different mechanism, different curtain, different tooling.' },
  { id:'euro-profile', cat:'Import & uncommon', keyway:'Euro profile / DIN cylinder', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge — but the body is the point', spaces:'', depths:'', makes:['ABUS','DOM','Wilka','GU','Roto','Winkhaus'],
    notes:'The keyed part of nearly every European door: a flat pear-shaped cylinder held by one screw through the faceplate. Rekeying means swapping the cylinder, not repinning in place, and cylinders are sized in 5mm steps per side — measure before you order. Increasingly common here on modern architecture and on every imported multipoint patio door.' },
  { id:'multipoint', cat:'Import & uncommon', keyway:'Multipoint gearbox & patio door', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Varies — usually a euro cylinder', spaces:'', depths:'', makes:['GU','Roto','Hoppe','Fuhr','Siegenia'],
  ...
  { id:'scandi-oval', cat:'Import & uncommon', keyway:'Scandinavian oval (ASSA / Ruko / Trioving)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'dimple-euro', cat:'Import & uncommon', keyway:'Dimple (Kaba / Keso / DOM / Wilka)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Dimple — drilled, not milled', spaces:'', depths:'', makes:['Kaba','Keso','DOM','Wilka','Kaba Gemini'],
    notes:'RESTRICTED on most. Pins read dimples drilled into the flats of the blade rather than cuts on the edge, often from two or three directions at once — Keso reads four rows. Cutting needs a dimple machine, not a standard duplicator. Mul-T-Lock is the dimple system most US shops already know; these are the German and Swiss equivalents.' },
  { id:'magnetic-key', cat:'Import & uncommon', keyway:'Magnetic (EVVA MCS)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'radial-fichet', cat:'Import & uncommon', keyway:'Radial & Fichet', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'miwa-goal', cat:'Import & uncommon', keyway:'Japanese residential (MIWA / GOAL / Alpha / Showa)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'lockwood-anz', cat:'Import & uncommon', keyway:'Australian & NZ (Lockwood / Whitco)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'ravbariach', cat:'Import & uncommon', keyway:'Israeli multipoint (Rav Bariach / Mul-T-Lock)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'godrej-india', cat:'Import & uncommon', keyway:'Indian lever padlock & mortise (Godrej / Harrison)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'import-bigbox', cat:'Import & uncommon', keyway:'Imported big-box cylinder (Chinese / Taiwanese)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge', spaces:'', depths:'', makes:['Import','Generic'],
    notes:'Unbranded and house-brand locksets built to loosely copy KW1 or SC1. The blade fits, the keying often does not: shallow depths, sloppy tolerances and pins that do not match either standard. A copy that works on the customer key may not work in the lock. Recommend replacing rather than rekeying — the cylinder costs less than the labour.' },
  { id:'latam-lock', cat:'Import & uncommon', keyway:'Latin American (Phillips / Yale Mexico)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge', spaces:'', depths:'', makes:['Phillips','Yale Mexico','Import'],
    notes:'Mexican and Central American residential hardware, which crosses the border constantly on doors, gates and furniture. Phillips is the major Mexican brand. Some profiles are close to US Yale sections and some are not — check the blade against the lock rather than the catalog.' },
  { id:'tubular-variants', cat:'Import & uncommon', keyway:'Tubular variants (7-pin / 8-pin / Ace II)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'euro-furniture', cat:'Import & uncommon', keyway:'European furniture & bit key', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'jdm-import', cat:'Automotive', keyway:'JDM grey import (25-year rule)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge on most', spaces:'', depths:'', makes:['Nissan','Toyota','Mitsubishi','Honda','Subaru','Import'],
    notes:'Genuinely growing work. A vehicle 25 years old is federally importable, so Skylines, Delicas, kei trucks and JDM vans are arriving steadily. The keyway is usually the same family as the US car of that year — a 1998 Skyline is Nissan NSN-family — but the immobilizer and the remote are JDM parts with no US supply, and a scan tool may not speak to a JDM ECU. Decode the lock, then check tool coverage separately.' },
  { id:'kei-vehicle', cat:'Automotive', keyway:'Kei class (Daihatsu / Suzuki / Honda kei)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge', spaces:'', depths:'', makes:['Daihatsu','Suzuki','Honda','Subaru','Mitsubishi'],
    notes:'Kei trucks and vans, imported by the container load for farms, wineries and campuses — which makes them a real Central Coast call. Mostly plain wafer ignitions with no chip, so the mechanical side is easy. Daihatsu never sold these here, so parts come from an importer rather than a dealer.' },
  { id:'ssangyong', cat:'Automotive', keyway:'SsangYong / KGM', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge / laser', spaces:'', depths:'', makes:['SsangYong','KGM','Daewoo'],
    notes:'Korean, never sold in the US, and built on Mercedes and Daewoo running gear across its history — which means the key system depends entirely on the era. You will meet one on a military or consular vehicle or not at all.' },
  { id:'lada-dacia', cat:'Automotive', keyway:'Lada / Dacia', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'chinese-marque', cat:'Automotive', keyway:'Chinese marques (BYD / MG / Chery / Geely / GWM)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'india-marque', cat:'Automotive', keyway:'Indian marques (Tata / Mahindra / Maruti)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  { id:'asean-marque', cat:'Automotive', keyway:'Proton / Perodua / VinFast', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
    cut:'Edge / laser', spaces:'', depths:'', makes:['Proton','Perodua','VinFast'],
    notes:'VinFast is the live one: Vietnamese, selling in California, with a proximity fob and a laser emergency blade. Confirm tool coverage before quoting anything on one — the aftermarket is barely there. Proton is Geely-owned and Perodua is Daihatsu-derived, and neither is a US market.' },
  { id:'euro-truck-import', cat:'Automotive', keyway:'European heavy truck (Scania / MAN / DAF / Iveco)', ilco:'—', ilcoChip:'—', silca:'—', jma:'—', strattec:'—',
  ...
  /* ---- residential and commercial catalog expansion ----------------------
     Individual North American cylinder, padlock and cabinet profiles verified
     against the Ilco Key Blank Directory, edition 13, section 2. The broader
     job-family rows remain because they carry field guidance; these exact rows
     make the keyway and Ilco/EZ cross-reference searchable. */
  { id:'cat-kw5', cat:'Residential', keyway:'KW5', ilco:'A1176', jma:'KWI-9D', cut:'Edge', makes:['Kwikset'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference KW5.' },
  { id:'cat-kw10', cat:'Residential', keyway:'KW10', ilco:'A1176ST', jma:'KWI-2D', image:'assets/key-blanks/cat-kw10.png', imageAlt:'JMA KWI-2D key blank', imageSource:'https://ecatalogo.jma.es/en/KWI-2D/1/imprimir_jma/', cut:'Edge', makes:['Kwikset'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference KW10.' },
  { id:'cat-kw11', cat:'Residential', keyway:'KW11', ilco:'A1176KT', jma:'KWI-5D', cut:'Edge', makes:['Kwikset'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference KW11.' },
  { id:'cat-wr2', cat:'Residential', keyway:'WR2', ilco:'X1054WA', jma:'WEI-17D', cut:'Edge', makes:['Weiser'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WR2.' },
  { id:'cat-wr3', cat:'Residential', keyway:'WR3', ilco:'1054WB', jma:'WEI-1', image:'assets/key-blanks/cat-wr3.png', imageAlt:'JMA WEI-1 key blank', imageSource:'https://ecatalogo.jma.es/en/WEI-1/1/imprimir_jma/', cut:'Edge', makes:['Weiser'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WR3.' },
  { id:'cat-wr4', cat:'Residential', keyway:'WR4', ilco:'A1054WB', jma:'WEI-2', cut:'Edge', makes:['Weiser'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WR4.' },
  { id:'cat-wr5', cat:'Residential', keyway:'WR5', ilco:'N1054WB', jma:'WEI-3', cut:'Edge', makes:['Weiser'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WR5.' },
  { id:'cat-wr6', cat:'Residential', keyway:'WR6', ilco:'N1176', jma:'WEI-18D', cut:'Edge', makes:['Weiser'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WR6.' },
  { id:'cat-wk1', cat:'Residential', keyway:'WK1', ilco:'1175', jma:'WES-3D', cut:'Edge', makes:['Weslock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WK1.' },
  { id:'cat-wk2', cat:'Residential', keyway:'WK2', ilco:'1175N', jma:'WES-1D', image:'assets/key-blanks/cat-wk2.png', imageAlt:'JMA WES-1D key blank', imageSource:'https://ecatalogo.jma.es/en/WES-1D/1/imprimir_jma/', cut:'Edge', makes:['Weslock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference WK2.' },
  { id:'cat-ar1', cat:'Residential', keyway:'AR1', ilco:'1179', jma:'ARR-4D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference AR1.' },
  { id:'cat-ar4', cat:'Residential', keyway:'AR4', ilco:'1179A', jma:'ARR-5D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference AR4.' },
  { id:'cat-ar1sc', cat:'Residential', keyway:'AR1SC', ilco:'1179SC', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference AR1SC.' },
  { id:'cat-sc6', cat:'Residential', keyway:'SC6', ilco:'1307A', jma:'SLG-1', image:'assets/key-blanks/cat-sc6.png', imageAlt:'JMA SLG-1 key blank', imageSource:'https://ecatalogo.jma.es/en/SLG-1/1/imprimir_jma/', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC6.' },
  { id:'cat-sc22', cat:'Residential', keyway:'SC22', ilco:'1307W', jma:'SLG-2', image:'assets/key-blanks/cat-sc22.png', imageAlt:'JMA SLG-2 key blank', imageSource:'https://ecatalogo.jma.es/en/SLG-2/1/imprimir_jma/', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC22.' },
  { id:'cat-sc8', cat:'Residential', keyway:'SC8', ilco:'1145E', jma:'SLG-11', image:'assets/key-blanks/cat-sc8.png', imageAlt:'JMA SLG-11 key blank', imageSource:'https://ecatalogo.jma.es/en/SLG-11/1/imprimir_jma/', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC8.' },
  { id:'cat-sc9', cat:'Residential', keyway:'SC9', ilco:'A1145E', jma:'SLG-5', image:'assets/key-blanks/cat-sc9.png', imageAlt:'JMA SLG-5 key blank', imageSource:'https://ecatalogo.jma.es/en/SLG-5/1/imprimir_jma/', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC9.' },
  { id:'cat-sc7', cat:'Residential', keyway:'SC7', ilco:'1145F', jma:'SLG-12', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC7.' },
  { id:'cat-sc10', cat:'Residential', keyway:'SC10', ilco:'A1145F', jma:'SLG-9', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC10.' },
  { id:'cat-sc15', cat:'Residential', keyway:'SC15', ilco:'1145H', jma:'SLG-23', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC15.' },
  { id:'cat-sc19', cat:'Residential', keyway:'SC19', ilco:'1145L', jma:'SLG-14', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC19.' },
  { id:'cat-sc20', cat:'Residential', keyway:'SC20', ilco:'A1145L', jma:'SLG-6', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SC20.' },
  { id:'cat-y2', cat:'Residential', keyway:'Y2', ilco:'999A', jma:'YA-17D', image:'assets/key-blanks/cat-y2.png', imageAlt:'JMA YA-17D key blank', imageSource:'https://ecatalogo.jma.es/en/YA-17D/1/imprimir_jma/', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y2.' },
  { id:'cat-y1e', cat:'Residential', keyway:'Y1E', ilco:'999N', jma:'YA-34D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y1E.' },
  { id:'cat-y3', cat:'Residential', keyway:'Y3', ilco:'C999', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference Y3.' },
  { id:'cat-y11', cat:'Residential', keyway:'Y11', ilco:'O1122', jma:'YA-44D', cut:'Edge', makes:['Yale / Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y11.' },
  { id:'cat-y13', cat:'Residential', keyway:'Y13', ilco:'O1122R', jma:'YA-44', cut:'Edge', makes:['Yale / Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y13.' },
  { id:'cat-y12', cat:'Residential', keyway:'Y12', ilco:'O1122A', jma:'YA-45D', cut:'Edge', makes:['Yale / Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y12.' },
  { id:'cat-y103', cat:'Residential', keyway:'Y103', ilco:'O1122B', jma:'YA-54D', cut:'Edge', makes:['Yale / Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y103.' },
  { id:'cat-y101', cat:'Residential', keyway:'Y101', ilco:'L1122A', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference Y101.' },
  { id:'cat-y5', cat:'Residential', keyway:'Y5', ilco:'997EB', jma:'YA-63D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y5.' },
  { id:'cat-y52', cat:'Residential', keyway:'Y52', ilco:'997E', jma:'YA-13D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y52.' },
  { id:'cat-y6', cat:'Residential', keyway:'Y6', ilco:'997X', jma:'YA-82D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y6.' },
  { id:'cat-y54', cat:'Residential', keyway:'Y54', ilco:'O997E', jma:'YA-25D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference Y54.' },
  { id:'cat-m2', cat:'Residential', keyway:'M2', ilco:'1092B', jma:'MAS-7', image:'assets/key-blanks/cat-m2.png', imageAlt:'JMA MAS-7 key blank', imageSource:'https://ecatalogo.jma.es/en/MAS-7/1/imprimir_jma/', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M2.' },
  { id:'cat-m17', cat:'Residential', keyway:'M17', ilco:'1092C', jma:'MAS-21D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M17.' },
  { id:'cat-m12', cat:'Residential', keyway:'M12', ilco:'1092D', jma:'MAS-3D', image:'assets/key-blanks/cat-m12.png', imageAlt:'JMA MAS-3D key blank', imageSource:'https://ecatalogo.jma.es/en/MAS-3D/1/imprimir_jma/', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M12.' },
  { id:'cat-m13', cat:'Residential', keyway:'M13', ilco:'1092DS', jma:'MAS-13D', image:'assets/key-blanks/cat-m13.png', imageAlt:'JMA MAS-13D key blank', imageSource:'https://ecatalogo.jma.es/en/MAS-13D/1/imprimir_jma/', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M13.' },
  { id:'cat-m27', cat:'Residential', keyway:'M27', ilco:'1092F', jma:'MAS-39D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M27.' },
  { id:'cat-m11', cat:'Residential', keyway:'M11', ilco:'1092H', jma:'MAS-5D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M11.' },
  { id:'cat-m14', cat:'Residential', keyway:'M14', ilco:'1092J', jma:'MAS-8', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M14.' },
  { id:'cat-m28', cat:'Residential', keyway:'M28', ilco:'1092K', jma:'MAS-40D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M28.' },
  { id:'cat-m29', cat:'Residential', keyway:'M29', ilco:'1092M', jma:'MAS-36D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M29.' },
  { id:'cat-m10', cat:'Residential', keyway:'M10', ilco:'1092N', jma:'MAS-9', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M10.' },
  { id:'cat-m16', cat:'Residential', keyway:'M16', ilco:'1092NR', jma:'MAS-9D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M16.' },
  { id:'cat-m4', cat:'Residential', keyway:'M4', ilco:'1092V', jma:'MAS-12D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M4.' },
  { id:'cat-m3', cat:'Residential', keyway:'M3', ilco:'1092VR', jma:'MAS-7D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M3.' },
  { id:'cat-m5', cat:'Residential', keyway:'M5', ilco:'1092VM', jma:'MAS-11D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M5.' },
  { id:'cat-m18', cat:'Residential', keyway:'M18', ilco:'1092-40', jma:'MAS-31D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M18.' },
  { id:'cat-m19', cat:'Residential', keyway:'M19', ilco:'1092-900', jma:'MAS-19', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M19.' },
  { id:'cat-m20', cat:'Residential', keyway:'M20', ilco:'1092-6000', jma:'MAS-18D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M20.' },
  { id:'cat-m25', cat:'Residential', keyway:'M25', ilco:'1092-6000B', jma:'MAS-25D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M25.' },
  { id:'cat-m21', cat:'Residential', keyway:'M21', ilco:'1092-7000', jma:'MAS-2D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M21.' },
  { id:'cat-m26', cat:'Residential', keyway:'M26', ilco:'1092-7000B', jma:'MAS-24D', cut:'Edge', makes:['Master Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference M26.' },
  { id:'cat-de1', cat:'Commercial', keyway:'DE1', ilco:'1054KD', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference DE1.' },
  { id:'cat-de5', cat:'Commercial', keyway:'DE5', ilco:'A1054KD', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference DE5.' },
  { id:'cat-de6', cat:'Commercial', keyway:'DE6', ilco:'D1054K', jma:'DX-5D', image:'assets/key-blanks/cat-de6.png', imageAlt:'JMA DX-5D key blank', imageSource:'https://ecatalogo.jma.es/en/DX-5D/1/imprimir_jma/', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference DE6.' },
  { id:'cat-de8', cat:'Commercial', keyway:'DE8', ilco:'D1054KA', jma:'DX-6D', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference DE8.' },
  { id:'cat-de2', cat:'Commercial', keyway:'DE2', ilco:'D1098B', jma:'DX-7D', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference DE2.' },
  { id:'cat-de4', cat:'Commercial', keyway:'DE4', ilco:'D1098X', jma:'DX-4', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference DE4.' },
  { id:'cat-de9', cat:'Commercial', keyway:'DE9', ilco:'DS1145', jma:'DX-37', cut:'Edge', makes:['Dexter / Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference DE9.' },
  { id:'cat-fa1', cat:'Commercial', keyway:'FA1', ilco:'1054WC', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference FA1.' },
  { id:'cat-fa2', cat:'Commercial', keyway:'FA2', ilco:'A1054WC', jma:'WEI-5', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference FA2.' },
  { id:'cat-be2', cat:'Commercial', keyway:'BE2', ilco:'A1114A', jma:'BES-1DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference BE2.' },
  { id:'cat-s1', cat:'Commercial', keyway:'S1', ilco:'1009', jma:'PR-6', image:'assets/key-blanks/cat-s1.png', imageAlt:'JMA PR-6 key blank', imageSource:'https://ecatalogo.jma.es/en/PR-6/1/imprimir_jma/', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference S1.' },
  { id:'cat-s2', cat:'Commercial', keyway:'S2', ilco:'O1009', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference S2.' },
  { id:'cat-s3', cat:'Commercial', keyway:'S3', ilco:'1010', jma:'KEI-1', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference S3.' },
  { id:'cat-s5', cat:'Commercial', keyway:'S5', ilco:'1009A', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference S5.' },
  { id:'cat-s10', cat:'Commercial', keyway:'S10', ilco:'1010B', jma:'SAR-4D', image:'assets/key-blanks/cat-s10.png', imageAlt:'JMA SAR-4D key blank', imageSource:'https://ecatalogo.jma.es/en/SAR-4D/1/imprimir_jma/', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference S10.' },
  { id:'cat-s22', cat:'Commercial', keyway:'S22', ilco:'O1007CA', jma:'SAR-29', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference S22.' },
  { id:'cat-s68', cat:'Commercial', keyway:'S68', ilco:'1010N', jma:'SAR-2D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference S68.' },
  { id:'cat-co1', cat:'Commercial', keyway:'CO1', ilco:'1000', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference CO1.' },
  { id:'cat-co2', cat:'Commercial', keyway:'CO2', ilco:'1000AB', jma:'COR-44', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO2.' },
  { id:'cat-co3', cat:'Commercial', keyway:'CO3', ilco:'1001EB', jma:'COR-81', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO3.' },
  { id:'cat-co4', cat:'Commercial', keyway:'CO4', ilco:'1001EA', jma:'COR-174', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO4.' },
  { id:'cat-co5', cat:'Commercial', keyway:'CO5', ilco:'1001', jma:'COR-83', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO5.' },
  { id:'cat-co7', cat:'Commercial', keyway:'CO7', ilco:'1001EN', jma:'COR-62', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO7.' },
  { id:'cat-co36', cat:'Commercial', keyway:'CO36', ilco:'1001EG', jma:'COR-45', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO36.' },
  { id:'cat-co37', cat:'Commercial', keyway:'CO37', ilco:'1001EL', jma:'COR-47', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO37.' },
  { id:'cat-co62', cat:'Commercial', keyway:'CO62', ilco:'R1001EG', jma:'COR-55D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO62.' },
  { id:'cat-co87', cat:'Commercial', keyway:'CO87', ilco:'1001EH', jma:'COR-8', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO87.' },
  { id:'cat-co88', cat:'Commercial', keyway:'CO88', ilco:'A1001EH', jma:'COR-9', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO88.' },
  { id:'cat-ru1', cat:'Commercial', keyway:'RU1', ilco:'1011', jma:'RUS-7', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RU1.' },
  { id:'cat-ru2', cat:'Commercial', keyway:'RU2', ilco:'1012', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference RU2.' },
  { id:'cat-ru3', cat:'Commercial', keyway:'RU3', ilco:'1011B', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference RU3.' },
  { id:'cat-ru4', cat:'Commercial', keyway:'RU4', ilco:'1011P', jma:'RUS-3', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RU4.' },
  { id:'cat-ru44', cat:'Commercial', keyway:'RU44', ilco:'1011GH', jma:'RUS-75D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RU44.' },
  { id:'cat-ru45', cat:'Commercial', keyway:'RU45', ilco:'1011D1', jma:'RUS-4', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RU45.' },
  { id:'cat-ru46', cat:'Commercial', keyway:'RU46', ilco:'A1011D1', jma:'RUS-5', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RU46.' },
  { id:'cat-ru101', cat:'Commercial', keyway:'RU101', ilco:'A1011-L4', jma:'RUS-14D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RU101.' },
  { id:'cat-se1', cat:'Commercial', keyway:'SE1', ilco:'1022', jma:'SEG-1D', cut:'Edge', makes:['Segal'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference SE1.' },
  { id:'cat-na1', cat:'Commercial', keyway:'NA1', ilco:'1064', jma:'VI-2I', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference NA1.' },
  { id:'cat-na6', cat:'Commercial', keyway:'NA6', ilco:'R1064D', jma:'NTL-2D', cut:'Edge', makes:['National Lock Hardware'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference NA6.' },
  { id:'cat-na25', cat:'Commercial', keyway:'NA25', ilco:'R1064E', jma:'NTL-1D', cut:'Edge', makes:['National / Amerock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference NA25.' },
  { id:'cat-na12', cat:'Commercial', keyway:'NA12', ilco:'1069LB', jma:'NTR-2D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference NA12.' },
  { id:'cat-na14', cat:'Commercial', keyway:'NA14', ilco:'1069L', jma:'NTC-1D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference NA14.' },
  { id:'cat-na15', cat:'Commercial', keyway:'NA15', ilco:'1692', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference NA15.' },
  { id:'cat-na24', cat:'Commercial', keyway:'NA24', ilco:'1069LC', jma:'NTR-1D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference NA24.' },
  { id:'cat-ro1', cat:'Commercial', keyway:'RO1', ilco:'1069', jma:'HUD-5D', cut:'Edge', makes:['National / Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO1.' },
  { id:'cat-ro3', cat:'Commercial', keyway:'RO3', ilco:'1069N', jma:'NTC-10D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO3.' },
  { id:'cat-ro4', cat:'Commercial', keyway:'RO4', ilco:'1069FL', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference RO4.' },
  { id:'cat-ro5', cat:'Commercial', keyway:'RO5', ilco:'1069M', jma:'NTC-9D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO5.' },
  { id:'cat-ro7', cat:'Commercial', keyway:'RO7', ilco:'1069G', jma:'NTC-7D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO7.' },
  { id:'cat-ro11', cat:'Commercial', keyway:'RO11', ilco:'1069H', jma:'NTC-8D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO11.' },
  { id:'cat-ro13', cat:'Commercial', keyway:'RO13', ilco:'N1069B', jma:'NTC-6', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO13.' },
  { id:'cat-ro15', cat:'Commercial', keyway:'RO15', ilco:'N1069N', jma:'NTC-15D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference RO15.' },
  { id:'cat-nh1', cat:'Commercial', keyway:'NH1', ilco:'1177N', cut:'Edge', makes:['National / Almet'], notes:'Ilco Key Blank Directory, edition 13, section 2; EZ reference NH1.' },
  { id:'cat-co68', cat:'Commercial', keyway:'CO68', ilco:'S1000V', jma:'CCL-11', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO68.' },
  { id:'cat-co26', cat:'Commercial', keyway:'CO26', ilco:'1000V', jma:'CCL-12', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO26.' },
  { id:'cat-co63', cat:'Commercial', keyway:'CO63', ilco:'1000X', jma:'CCL-5D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO63.' },
  { id:'cat-co106', cat:'Commercial', keyway:'CO106', ilco:'1003M', jma:'HUD-3', cut:'Edge', makes:['Hudson / National'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CO106.' },
  { id:'cat-bo1', cat:'Commercial', keyway:'BO1', ilco:'R1003M', jma:'HUD-3D', cut:'Edge', makes:['Hudson / Bommer'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference BO1.' },
  { id:'cat-cg16', cat:'Commercial', keyway:'CG16', ilco:'1041T', jma:'CHI-12D', image:'assets/key-blanks/cat-cg16.png', imageAlt:'JMA CHI-12D key blank', imageSource:'https://ecatalogo.jma.es/en/CHI-12D/1/imprimir_jma/', cut:'Edge', makes:['Chicago / Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CG16.' },
  { id:'cat-cg17', cat:'Commercial', keyway:'CG17', ilco:'1041Y', jma:'CHI-13D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CG17.' },
  { id:'cat-cg22', cat:'Commercial', keyway:'CG22', ilco:'1041E', jma:'CHI-14', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference CG22.' },
  { id:'cat-ap2', cat:'Commercial', keyway:'AP2', ilco:'102AM', jma:'CHI-10D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference AP2.' },
  { id:'cat-ap3', cat:'Commercial', keyway:'AP3', ilco:'103AM', jma:'CHI-8D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference AP3.' },
  { id:'cat-ap4', cat:'Commercial', keyway:'AP4', ilco:'104AM', jma:'CHI-7D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference AP4.' },
  { id:'cat-ap5', cat:'Commercial', keyway:'AP5', ilco:'100AM', jma:'CHI-11', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference AP5.' },
  { id:'cat-il1', cat:'Commercial', keyway:'IL1', ilco:'1041H', jma:'ILL-1', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference IL1.' },
  { id:'cat-il9', cat:'Commercial', keyway:'IL9', ilco:'1043B', jma:'ILL-2D', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference IL9.' },
  { id:'cat-il11', cat:'Commercial', keyway:'IL11', ilco:'1043J', jma:'TIM-1D', cut:'Edge', makes:['Illinois / Timberline'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2; EZ reference IL11.' },
  { id:'cat-medeco-1515', cat:'Commercial', keyway:'Medeco 1515', ilco:'1515', jma:'MDC-14DS', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-medeco-1517', cat:'Commercial', keyway:'Medeco 1517', ilco:'1517', jma:'MDC-1S', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-medeco-1518', cat:'Commercial', keyway:'Medeco 1518', ilco:'1518', jma:'MDC-10S', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-medeco-1542', cat:'Commercial', keyway:'Medeco 1542', ilco:'1542', jma:'MDC-12DS', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-medeco-1543', cat:'Commercial', keyway:'Medeco 1543', ilco:'1543', jma:'MDC-7S', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-medeco-1638', cat:'Commercial', keyway:'Medeco 1638', ilco:'1638', jma:'MDC-5S', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-medeco-1644', cat:'Commercial', keyway:'Medeco 1644', ilco:'1644', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13, section 2.' },
  { id:'cat-medeco-1655', cat:'Commercial', keyway:'Medeco 1655', ilco:'1655', jma:'MDC-6S', cut:'Edge', makes:['Medeco'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-a', cat:'Commercial', keyway:'BEST-A2A', ilco:'1A1A1', jma:'BES-1DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-b', cat:'Commercial', keyway:'BEST-A2B', ilco:'1A1B1', jma:'BES-14DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-c', cat:'Commercial', keyway:'BEST-A2C', ilco:'1A1C1', jma:'BES-2DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-d', cat:'Commercial', keyway:'BEST-A2D', ilco:'1A1D1', jma:'BES-3DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-e', cat:'Commercial', keyway:'BEST-A2E', ilco:'1A1E1', jma:'BES-5DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-f', cat:'Commercial', keyway:'BEST-A2F', ilco:'1A1F1', jma:'BES-16DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-g', cat:'Commercial', keyway:'BEST-A2G', ilco:'1A1G1', jma:'BES-6DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-h', cat:'Commercial', keyway:'BEST-A2H', ilco:'1A1H1', jma:'BES-7DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-j', cat:'Commercial', keyway:'BEST-A2J', ilco:'1A1J1', jma:'BES-8DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  { id:'cat-best-a2-k', cat:'Commercial', keyway:'BEST-A2K', ilco:'1A1K1', jma:'BES-9DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2.' },
  /* ---- Edition 13 manufacturer-series expansion -------------------------
     Additional exact Ilco blanks transcribed from the North American cylinder
     plates. Manufacturer names stay in each searchable keyway so similar blank
     numbers from different systems do not collide in cross-reference matching. */
  { id:'cat13-american-lock-1041b', cat:'Residential', keyway:'American Lock 1041B', ilco:'1041B', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 216.' },
  { id:'cat13-american-lock-1041c', cat:'Residential', keyway:'American Lock 1041C', ilco:'1041C', jma:'AME-3', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-1045', cat:'Residential', keyway:'American Lock 1045', ilco:'1045', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 216.' },
  { id:'cat13-american-lock-a1045', cat:'Residential', keyway:'American Lock A1045', ilco:'A1045', jma:'AME-2', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-1046', cat:'Residential', keyway:'American Lock 1046', ilco:'1046', jma:'JU-1', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-1046a', cat:'Residential', keyway:'American Lock 1046A', ilco:'1046A', jma:'JU-2', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-1045l', cat:'Residential', keyway:'American Lock 1045L', ilco:'1045L', jma:'AME-8', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-a1045l', cat:'Residential', keyway:'American Lock A1045L', ilco:'A1045L', jma:'AME-9', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-1653', cat:'Residential', keyway:'American Lock 1653', ilco:'1653', jma:'AME-4', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 216.' },
  { id:'cat13-american-lock-ak22w', cat:'Residential', keyway:'American Lock AK22W', ilco:'AK22W', cut:'Edge', makes:['American Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 216.' },
  { id:'cat13-arrow-1179', cat:'Commercial', keyway:'Arrow 1179', ilco:'1179', jma:'ARR-4D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-ar1-pc', cat:'Commercial', keyway:'Arrow AR1-PC', ilco:'AR1-PC', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 217.' },
  { id:'cat13-arrow-n1179', cat:'Commercial', keyway:'Arrow N1179', ilco:'N1179', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 217.' },
  { id:'cat13-arrow-1179a', cat:'Commercial', keyway:'Arrow 1179A', ilco:'1179A', jma:'ARR-5D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-n1179a', cat:'Commercial', keyway:'Arrow N1179A', ilco:'N1179A', jma:'ARR-6D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-1179sc', cat:'Commercial', keyway:'Arrow 1179SC', ilco:'1179SC', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 217.' },
  { id:'cat13-arrow-a1179e', cat:'Commercial', keyway:'Arrow A1179E', ilco:'A1179E', jma:'ARR-10', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179f', cat:'Commercial', keyway:'Arrow A1179F', ilco:'A1179F', jma:'ARR-11', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179g', cat:'Commercial', keyway:'Arrow A1179G', ilco:'A1179G', jma:'ARR-12', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179h', cat:'Commercial', keyway:'Arrow A1179H', ilco:'A1179H', jma:'ARR-13', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179j', cat:'Commercial', keyway:'Arrow A1179J', ilco:'A1179J', jma:'ARR-14', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179k', cat:'Commercial', keyway:'Arrow A1179K', ilco:'A1179K', jma:'ARR-15', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179l', cat:'Commercial', keyway:'Arrow A1179L', ilco:'A1179L', jma:'ARR-16', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179n', cat:'Commercial', keyway:'Arrow A1179N', ilco:'A1179N', jma:'ARR-17', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179p', cat:'Commercial', keyway:'Arrow A1179P', ilco:'A1179P', jma:'ARR-18', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179r', cat:'Commercial', keyway:'Arrow A1179R', ilco:'A1179R', jma:'ARR-19', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179s', cat:'Commercial', keyway:'Arrow A1179S', ilco:'A1179S', jma:'ARR-20', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179t', cat:'Commercial', keyway:'Arrow A1179T', ilco:'A1179T', jma:'ARR-21', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179u', cat:'Commercial', keyway:'Arrow A1179U', ilco:'A1179U', jma:'ARR-22', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-a1179v', cat:'Commercial', keyway:'Arrow A1179V', ilco:'A1179V', jma:'ARR-23', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-b1179-1c', cat:'Commercial', keyway:'Arrow B1179-1C', ilco:'B1179-1C', jma:'ARR-9D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-arrow-b1179-1d', cat:'Commercial', keyway:'Arrow B1179-1D', ilco:'B1179-1D', jma:'ARR-7D', cut:'Edge', makes:['Arrow'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 217.' },
  { id:'cat13-best-1114', cat:'Commercial', keyway:'Best 1114', ilco:'1114', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 218-219.' },
  { id:'cat13-best-a1114a', cat:'Commercial', keyway:'Best A1114A', ilco:'A1114A', jma:'BES-1DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114b', cat:'Commercial', keyway:'Best A1114B', ilco:'A1114B', jma:'BES-14DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114c', cat:'Commercial', keyway:'Best A1114C', ilco:'A1114C', jma:'BES-2DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114d', cat:'Commercial', keyway:'Best A1114D', ilco:'A1114D', jma:'BES-3DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114dd', cat:'Commercial', keyway:'Best A1114DD', ilco:'A1114DD', jma:'BES-4DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114e', cat:'Commercial', keyway:'Best A1114E', ilco:'A1114E', jma:'BES-5DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114f', cat:'Commercial', keyway:'Best A1114F', ilco:'A1114F', jma:'BES-16DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114fm', cat:'Commercial', keyway:'Best A1114FM', ilco:'A1114FM', jma:'BES-15DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114g', cat:'Commercial', keyway:'Best A1114G', ilco:'A1114G', jma:'BES-6DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114h', cat:'Commercial', keyway:'Best A1114H', ilco:'A1114H', jma:'BES-7DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114j', cat:'Commercial', keyway:'Best A1114J', ilco:'A1114J', jma:'BES-8DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114k', cat:'Commercial', keyway:'Best A1114K', ilco:'A1114K', jma:'BES-9DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114l', cat:'Commercial', keyway:'Best A1114L', ilco:'A1114L', jma:'BES-10DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114m', cat:'Commercial', keyway:'Best A1114M', ilco:'A1114M', jma:'BES-11DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114q', cat:'Commercial', keyway:'Best A1114Q', ilco:'A1114Q', jma:'BES-12DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114r', cat:'Commercial', keyway:'Best A1114R', ilco:'A1114R', jma:'BES-13DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-best-a1114tb', cat:'Commercial', keyway:'Best A1114TB', ilco:'A1114TB', jma:'BES-17DS', cut:'Edge', makes:['Best'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 218-219.' },
  { id:'cat13-chicago-102am', cat:'Commercial', keyway:'Chicago 102AM', ilco:'102AM', jma:'CHI-10D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-103am', cat:'Commercial', keyway:'Chicago 103AM', ilco:'103AM', jma:'CHI-8D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-104am', cat:'Commercial', keyway:'Chicago 104AM', ilco:'104AM', jma:'CHI-7D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-100am', cat:'Commercial', keyway:'Chicago 100AM', ilco:'100AM', jma:'CHI-11', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041e', cat:'Commercial', keyway:'Chicago 1041E', ilco:'1041E', jma:'CHI-14', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041t', cat:'Commercial', keyway:'Chicago 1041T', ilco:'1041T', jma:'CHI-12D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041tr', cat:'Commercial', keyway:'Chicago 1041TR', ilco:'1041TR', jma:'CHI-12', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041x', cat:'Commercial', keyway:'Chicago 1041X', ilco:'1041X', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1041y', cat:'Commercial', keyway:'Chicago 1041Y', ilco:'1041Y', jma:'CHI-13D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041a', cat:'Commercial', keyway:'Chicago C1041A', ilco:'C1041A', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041b', cat:'Commercial', keyway:'Chicago C1041B', ilco:'C1041B', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041c', cat:'Commercial', keyway:'Chicago C1041C', ilco:'C1041C', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041j', cat:'Commercial', keyway:'Chicago C1041J', ilco:'C1041J', jma:'CHI-17D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041l', cat:'Commercial', keyway:'Chicago C1041L', ilco:'C1041L', jma:'CHI-18', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041n', cat:'Commercial', keyway:'Chicago C1041N', ilco:'C1041N', jma:'CHI-19D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041p', cat:'Commercial', keyway:'Chicago C1041P', ilco:'C1041P', jma:'CHI-15D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-h1041t', cat:'Commercial', keyway:'Chicago H1041T', ilco:'H1041T', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-s1041ja', cat:'Commercial', keyway:'Chicago S1041JA', ilco:'S1041JA', jma:'CHI-16D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-s1041t', cat:'Commercial', keyway:'Chicago S1041T', ilco:'S1041T', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-sc1041r', cat:'Commercial', keyway:'Chicago SC1041R', ilco:'SC1041R', jma:'CHI-20', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041r', cat:'Commercial', keyway:'Chicago C1041R', ilco:'C1041R', jma:'CHI-24', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-sc1041tr', cat:'Commercial', keyway:'Chicago SC1041TR', ilco:'SC1041TR', jma:'CHI-22D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041tr', cat:'Commercial', keyway:'Chicago C1041TR', ilco:'C1041TR', jma:'CHI-26D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-sc1041s', cat:'Commercial', keyway:'Chicago SC1041S', ilco:'SC1041S', jma:'CHI-21', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041jb', cat:'Commercial', keyway:'Chicago C1041JB', ilco:'C1041JB', jma:'CHI-25', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-sc1041yr', cat:'Commercial', keyway:'Chicago SC1041YR', ilco:'SC1041YR', jma:'CHI-23', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041yr', cat:'Commercial', keyway:'Chicago C1041YR', ilco:'C1041YR', jma:'CHI-27', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-sc1041sr', cat:'Commercial', keyway:'Chicago SC1041SR', ilco:'SC1041SR', jma:'CHI-21D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041sr', cat:'Commercial', keyway:'Chicago C1041SR', ilco:'C1041SR', jma:'CHI-25D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-sc1041t', cat:'Commercial', keyway:'Chicago SC1041T', ilco:'SC1041T', jma:'CHI-22', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041t', cat:'Commercial', keyway:'Chicago C1041T', ilco:'C1041T', jma:'CHI-26', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1096en', cat:'Commercial', keyway:'Chicago 1096EN', ilco:'1096EN', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1136s', cat:'Commercial', keyway:'Chicago 1136S', ilco:'1136S', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1137b', cat:'Commercial', keyway:'Chicago 1137B', ilco:'1137B', jma:'CHI-1T', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1137s', cat:'Commercial', keyway:'Chicago 1137S', ilco:'1137S', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-l1137', cat:'Commercial', keyway:'Chicago L1137', ilco:'L1137', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-41fd', cat:'Commercial', keyway:'Chicago 41FD', ilco:'41FD', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-cc21', cat:'Commercial', keyway:'Chicago CC21', ilco:'CC21', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-cc29', cat:'Commercial', keyway:'Chicago CC29', ilco:'CC29', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-cc30', cat:'Commercial', keyway:'Chicago CC30', ilco:'CC30', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1041d', cat:'Commercial', keyway:'Chicago 1041D', ilco:'1041D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1041dc', cat:'Commercial', keyway:'Chicago 1041DC', ilco:'1041DC', jma:'CHI-30', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041de', cat:'Commercial', keyway:'Chicago 1041DE', ilco:'1041DE', jma:'CHI-32D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041dh', cat:'Commercial', keyway:'Chicago 1041DH', ilco:'1041DH', jma:'CHI-33D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041fe', cat:'Commercial', keyway:'Chicago 1041FE', ilco:'1041FE', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1041fg', cat:'Commercial', keyway:'Chicago 1041FG', ilco:'1041FG', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1041g', cat:'Commercial', keyway:'Chicago 1041G', ilco:'1041G', jma:'CHI-2', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041ga', cat:'Commercial', keyway:'Chicago 1041GA', ilco:'1041GA', jma:'CHI-1', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041gb', cat:'Commercial', keyway:'Chicago 1041GB', ilco:'1041GB', jma:'CHI-4', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041gr', cat:'Commercial', keyway:'Chicago 1041GR', ilco:'1041GR', jma:'CHI-3', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041k', cat:'Commercial', keyway:'Chicago 1041K', ilco:'1041K', jma:'CHI-35', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-1041m', cat:'Commercial', keyway:'Chicago 1041M', ilco:'1041M', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 220-222.' },
  { id:'cat13-chicago-1041n', cat:'Commercial', keyway:'Chicago 1041N', ilco:'1041N', jma:'CHI-5', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-c1041dn', cat:'Commercial', keyway:'Chicago C1041DN', ilco:'C1041DN', jma:'CHI-34', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-chicago-r1041dc', cat:'Commercial', keyway:'Chicago R1041DC', ilco:'R1041DC', jma:'CHI-30D', cut:'Edge', makes:['Chicago'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 220-222.' },
  { id:'cat13-ccl-1000f', cat:'Commercial', keyway:'CCL 1000F', ilco:'1000F', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1000g', cat:'Commercial', keyway:'CCL 1000G', ilco:'1000G', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1000h', cat:'Commercial', keyway:'CCL 1000H', ilco:'1000H', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1000fr', cat:'Commercial', keyway:'CCL 1000FR', ilco:'1000FR', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-x1000f', cat:'Commercial', keyway:'CCL X1000F', ilco:'X1000F', jma:'CCL-3D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-x1000fr', cat:'Commercial', keyway:'CCL X1000FR', ilco:'X1000FR', jma:'CCL-3', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-x1000g', cat:'Commercial', keyway:'CCL X1000G', ilco:'X1000G', jma:'CCL-1D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-x1000gr', cat:'Commercial', keyway:'CCL X1000GR', ilco:'X1000GR', jma:'CCL-1', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-xo1000f', cat:'Commercial', keyway:'CCL XO1000F', ilco:'XO1000F', jma:'CCL-26D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-xo1000gr', cat:'Commercial', keyway:'CCL XO1000GR', ilco:'XO1000GR', jma:'CCL-27', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-sx1000f', cat:'Commercial', keyway:'CCL SX1000F', ilco:'SX1000F', jma:'CCL-2D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-sx1000fr', cat:'Commercial', keyway:'CCL SX1000FR', ilco:'SX1000FR', jma:'CCL-2', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-o1000h', cat:'Commercial', keyway:'CCL O1000H', ilco:'O1000H', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-o1000gx', cat:'Commercial', keyway:'CCL O1000GX', ilco:'O1000GX', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-o1000gr', cat:'Commercial', keyway:'CCL O1000GR', ilco:'O1000GR', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1000kc', cat:'Commercial', keyway:'CCL 1000KC', ilco:'1000KC', jma:'CCL-35D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1000k', cat:'Commercial', keyway:'CCL 1000K', ilco:'1000K', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-x1000kc', cat:'Commercial', keyway:'CCL X1000KC', ilco:'X1000KC', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1000da', cat:'Commercial', keyway:'CCL 1000DA', ilco:'1000DA', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1000w', cat:'Commercial', keyway:'CCL 1000W', ilco:'1000W', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-s1000t', cat:'Commercial', keyway:'CCL S1000T', ilco:'S1000T', jma:'CCL-29', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1000t', cat:'Commercial', keyway:'CCL 1000T', ilco:'1000T', jma:'CCL-32', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-sr1000t', cat:'Commercial', keyway:'CCL SR1000T', ilco:'SR1000T', jma:'CCL-29D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-r1000t', cat:'Commercial', keyway:'CCL R1000T', ilco:'R1000T', jma:'CCL-32D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-s1000v', cat:'Commercial', keyway:'CCL S1000V', ilco:'S1000V', jma:'CCL-11', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1000v', cat:'Commercial', keyway:'CCL 1000V', ilco:'1000V', jma:'CCL-12', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-sr1000v', cat:'Commercial', keyway:'CCL SR1000V', ilco:'SR1000V', jma:'CCL-11D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-r1000v', cat:'Commercial', keyway:'CCL R1000V', ilco:'R1000V', jma:'CCL-12D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-s1000x', cat:'Commercial', keyway:'CCL S1000X', ilco:'S1000X', jma:'CCL-28D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1000x', cat:'Commercial', keyway:'CCL 1000X', ilco:'1000X', jma:'CCL-5D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1000xk', cat:'Commercial', keyway:'CCL 1000XK', ilco:'1000XK', jma:'CCL-34D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1000p', cat:'Commercial', keyway:'CCL 1000P', ilco:'1000P', jma:'CCL-33D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1001cr', cat:'Commercial', keyway:'CCL 1001CR', ilco:'1001CR', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1001d', cat:'Commercial', keyway:'CCL 1001D', ilco:'1001D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-r1001d', cat:'Commercial', keyway:'CCL R1001D', ilco:'R1001D', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1001da', cat:'Commercial', keyway:'CCL 1001DA', ilco:'1001DA', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-1001k', cat:'Commercial', keyway:'CCL 1001K', ilco:'1001K', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-x1001kc', cat:'Commercial', keyway:'CCL X1001KC', ilco:'X1001KC', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 223-225.' },
  { id:'cat13-ccl-s1003a', cat:'Commercial', keyway:'CCL S1003A', ilco:'S1003A', jma:'CCL-36', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1003a', cat:'Commercial', keyway:'CCL 1003A', ilco:'1003A', jma:'CCL-14', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-l1003a', cat:'Commercial', keyway:'CCL L1003A', ilco:'L1003A', jma:'CCL-20', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-s1003ab', cat:'Commercial', keyway:'CCL S1003AB', ilco:'S1003AB', jma:'CCL-40', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1003ab', cat:'Commercial', keyway:'CCL 1003AB', ilco:'1003AB', jma:'CCL-18', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-l1003ab', cat:'Commercial', keyway:'CCL L1003AB', ilco:'L1003AB', jma:'CCL-24', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1003cd', cat:'Commercial', keyway:'CCL 1003CD', ilco:'1003CD', jma:'CCL-19', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-s1003m', cat:'Commercial', keyway:'CCL S1003M', ilco:'S1003M', jma:'CCL-42', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-1003m', cat:'Commercial', keyway:'CCL 1003M', ilco:'1003M', jma:'HUD-3', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-ccl-l1003m', cat:'Commercial', keyway:'CCL L1003M', ilco:'L1003M', jma:'CCL-10', cut:'Edge', makes:['CCL'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 223-225.' },
  { id:'cat13-corbin-cb1', cat:'Commercial', keyway:'Corbin CB1', ilco:'CB1', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 226-229.' },
  { id:'cat13-corbin-cb2', cat:'Commercial', keyway:'Corbin CB2', ilco:'CB2', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 226-229.' },
  { id:'cat13-corbin-cb3', cat:'Commercial', keyway:'Corbin CB3', ilco:'CB3', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 226-229.' },
  { id:'cat13-corbin-cb7', cat:'Commercial', keyway:'Corbin CB7', ilco:'CB7', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 226-229.' },
  { id:'cat13-corbin-cb9', cat:'Commercial', keyway:'Corbin CB9', ilco:'CB9', jma:'CLB-5', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-cb10', cat:'Commercial', keyway:'Corbin CB10', ilco:'CB10', jma:'CLB-5D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-cb11', cat:'Commercial', keyway:'Corbin CB11', ilco:'CB11', jma:'CLB-6', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1000', cat:'Commercial', keyway:'Corbin 1000', ilco:'1000', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 226-229.' },
  { id:'cat13-corbin-1000a', cat:'Commercial', keyway:'Corbin 1000A', ilco:'1000A', jma:'COR-46', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1000ab', cat:'Commercial', keyway:'Corbin 1000AB', ilco:'1000AB', jma:'COR-44', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001ea', cat:'Commercial', keyway:'Corbin 1001EA', ilco:'1001EA', jma:'COR-174', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001e', cat:'Commercial', keyway:'Corbin 1001E', ilco:'1001E', jma:'COR-156', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001mj', cat:'Commercial', keyway:'Corbin 1001MJ', ilco:'1001MJ', jma:'COR-109', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001mj', cat:'Commercial', keyway:'Corbin A1001MJ', ilco:'A1001MJ', jma:'COR-112', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001en', cat:'Commercial', keyway:'Corbin 1001EN', ilco:'1001EN', jma:'COR-62', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001eg', cat:'Commercial', keyway:'Corbin 1001EG', ilco:'1001EG', jma:'COR-45', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001es', cat:'Commercial', keyway:'Corbin 1001ES', ilco:'1001ES', jma:'COR-110', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-b1001ej', cat:'Commercial', keyway:'Corbin B1001EJ', ilco:'B1001EJ', jma:'COR-113', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001eb', cat:'Commercial', keyway:'Corbin 1001EB', ilco:'1001EB', jma:'COR-81', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001hp', cat:'Commercial', keyway:'Corbin A1001HP', ilco:'A1001HP', jma:'COR-111D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001el', cat:'Commercial', keyway:'Corbin 1001EL', ilco:'1001EL', jma:'COR-47', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-r1001mj', cat:'Commercial', keyway:'Corbin R1001MJ', ilco:'R1001MJ', jma:'COR-177D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-r1001eg', cat:'Commercial', keyway:'Corbin R1001EG', ilco:'R1001EG', jma:'COR-55D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-r1001en', cat:'Commercial', keyway:'Corbin R1001EN', ilco:'R1001EN', jma:'SKI-1D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-r1001et', cat:'Commercial', keyway:'Corbin R1001ET', ilco:'R1001ET', jma:'COR-173D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-r1001es', cat:'Commercial', keyway:'Corbin R1001ES', ilco:'R1001ES', jma:'COR-178D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-r1001el', cat:'Commercial', keyway:'Corbin R1001EL', ilco:'R1001EL', jma:'COR-161D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001mjr', cat:'Commercial', keyway:'Corbin A1001MJR', ilco:'A1001MJR', jma:'COR-172D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001ah', cat:'Commercial', keyway:'Corbin 1001AH', ilco:'1001AH', jma:'COR-86', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001fh', cat:'Commercial', keyway:'Corbin 1001FH', ilco:'1001FH', jma:'COR-87', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001c1', cat:'Commercial', keyway:'Corbin 1001C1', ilco:'1001C1', jma:'COR-90', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001c2', cat:'Commercial', keyway:'Corbin 1001C2', ilco:'1001C2', jma:'COR-91', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001d1', cat:'Commercial', keyway:'Corbin 1001D1', ilco:'1001D1', jma:'COR-92', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001d2', cat:'Commercial', keyway:'Corbin 1001D2', ilco:'1001D2', jma:'COR-93', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001ah', cat:'Commercial', keyway:'Corbin A1001AH', ilco:'A1001AH', jma:'COR-63', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001fh', cat:'Commercial', keyway:'Corbin A1001FH', ilco:'A1001FH', jma:'COR-101', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001bh', cat:'Commercial', keyway:'Corbin A1001BH', ilco:'A1001BH', jma:'COR-60', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001dh', cat:'Commercial', keyway:'Corbin A1001DH', ilco:'A1001DH', jma:'COR-57', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001c1', cat:'Commercial', keyway:'Corbin A1001C1', ilco:'A1001C1', jma:'COR-58', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001c2', cat:'Commercial', keyway:'Corbin A1001C2', ilco:'A1001C2', jma:'COR-102', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001d1', cat:'Commercial', keyway:'Corbin A1001D1', ilco:'A1001D1', jma:'COR-59', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001d2', cat:'Commercial', keyway:'Corbin A1001D2', ilco:'A1001D2', jma:'COR-103', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-l1001ah', cat:'Commercial', keyway:'Corbin L1001AH', ilco:'L1001AH', jma:'COR-139', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-l1001bh', cat:'Commercial', keyway:'Corbin L1001BH', ilco:'L1001BH', jma:'COR-141', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-l1001d2', cat:'Commercial', keyway:'Corbin L1001D2', ilco:'L1001D2', jma:'COR-146', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001am', cat:'Commercial', keyway:'Corbin 1001AM', ilco:'1001AM', jma:'COR-94', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001bm', cat:'Commercial', keyway:'Corbin 1001BM', ilco:'1001BM', jma:'COR-95', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001cm', cat:'Commercial', keyway:'Corbin 1001CM', ilco:'1001CM', jma:'COR-96', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001dm', cat:'Commercial', keyway:'Corbin 1001DM', ilco:'1001DM', jma:'COR-97', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001am', cat:'Commercial', keyway:'Corbin A1001AM', ilco:'A1001AM', jma:'COR-104', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001bm', cat:'Commercial', keyway:'Corbin A1001BM', ilco:'A1001BM', jma:'COR-105', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001cm', cat:'Commercial', keyway:'Corbin A1001CM', ilco:'A1001CM', jma:'COR-106', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001dm', cat:'Commercial', keyway:'Corbin A1001DM', ilco:'A1001DM', jma:'COR-107', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001abm', cat:'Commercial', keyway:'Corbin 1001ABM', ilco:'1001ABM', jma:'COR-98', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001cdm', cat:'Commercial', keyway:'Corbin 1001CDM', ilco:'1001CDM', jma:'COR-99', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001abm', cat:'Commercial', keyway:'Corbin A1001ABM', ilco:'A1001ABM', jma:'COR-56', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001cdm', cat:'Commercial', keyway:'Corbin A1001CDM', ilco:'A1001CDM', jma:'COR-108', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-l1001abm', cat:'Commercial', keyway:'Corbin L1001ABM', ilco:'L1001ABM', jma:'COR-151', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001grm', cat:'Commercial', keyway:'Corbin 1001GRM', ilco:'1001GRM', jma:'COR-100', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001grm', cat:'Commercial', keyway:'Corbin A1001GRM', ilco:'A1001GRM', jma:'COR-61', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-l1001grm', cat:'Commercial', keyway:'Corbin L1001GRM', ilco:'L1001GRM', jma:'COR-153', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001eh', cat:'Commercial', keyway:'Corbin 1001EH', ilco:'1001EH', jma:'COR-8', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001eh', cat:'Commercial', keyway:'Corbin A1001EH', ilco:'A1001EH', jma:'COR-9', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-l1001eh', cat:'Commercial', keyway:'Corbin L1001EH', ilco:'L1001EH', jma:'COR-222', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-a1001ehr', cat:'Commercial', keyway:'Corbin A1001EHR', ilco:'A1001EHR', jma:'COR-9D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001', cat:'Commercial', keyway:'Corbin 1001', ilco:'1001', jma:'COR-83', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001a', cat:'Commercial', keyway:'Corbin 1001A', ilco:'1001A', jma:'COR-85', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001ab', cat:'Commercial', keyway:'Corbin 1001AB', ilco:'1001AB', jma:'COR-84', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001a1', cat:'Commercial', keyway:'Corbin 1001A1', ilco:'1001A1', jma:'COR-154D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001a2', cat:'Commercial', keyway:'Corbin 1001A2', ilco:'1001A2', jma:'COR-155D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001c', cat:'Commercial', keyway:'Corbin 1001C', ilco:'1001C', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 226-229.' },
  { id:'cat13-corbin-1001ga', cat:'Commercial', keyway:'Corbin 1001GA', ilco:'1001GA', jma:'COR-220D', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-1001gh', cat:'Commercial', keyway:'Corbin 1001GH', ilco:'1001GH', jma:'COR-7', cut:'Edge', makes:['Corbin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 226-229.' },
  { id:'cat13-corbin-russwin-1011-l1', cat:'Commercial', keyway:'Corbin Russwin 1011-L1', ilco:'1011-L1', jma:'RUS-4D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1011-l2', cat:'Commercial', keyway:'Corbin Russwin 1011-L2', ilco:'1011-L2', jma:'RUS-30D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1011-l3', cat:'Commercial', keyway:'Corbin Russwin 1011-L3', ilco:'1011-L3', jma:'RUS-31D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1011-l4', cat:'Commercial', keyway:'Corbin Russwin 1011-L4', ilco:'1011-L4', jma:'RUS-32D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l1', cat:'Commercial', keyway:'Corbin Russwin A1011-L1', ilco:'A1011-L1', jma:'RUS-5D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l2', cat:'Commercial', keyway:'Corbin Russwin A1011-L2', ilco:'A1011-L2', jma:'RUS-8D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l3', cat:'Commercial', keyway:'Corbin Russwin A1011-L3', ilco:'A1011-L3', jma:'RUS-9D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l4', cat:'Commercial', keyway:'Corbin Russwin A1011-L4', ilco:'A1011-L4', jma:'RUS-14D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-l1011-l4', cat:'Commercial', keyway:'Corbin Russwin L1011-L4', ilco:'L1011-L4', jma:'COR-134D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1011-l12', cat:'Commercial', keyway:'Corbin Russwin 1011-L12', ilco:'1011-L12', jma:'RUS-33D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1011-l34', cat:'Commercial', keyway:'Corbin Russwin 1011-L34', ilco:'1011-L34', jma:'RUS-34D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l12', cat:'Commercial', keyway:'Corbin Russwin A1011-L12', ilco:'A1011-L12', jma:'RUS-36D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l34', cat:'Commercial', keyway:'Corbin Russwin A1011-L34', ilco:'A1011-L34', jma:'RUS-37D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1011-l41', cat:'Commercial', keyway:'Corbin Russwin 1011-L41', ilco:'1011-L41', jma:'RUS-35D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1011-l41', cat:'Commercial', keyway:'Corbin Russwin A1011-L41', ilco:'A1011-L41', jma:'RUS-13D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-l1011-l41', cat:'Commercial', keyway:'Corbin Russwin L1011-L41', ilco:'L1011-L41', jma:'COR-137D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1012-d1', cat:'Commercial', keyway:'Corbin Russwin 1012-D1', ilco:'1012-D1', jma:'COR-194', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-d1', cat:'Commercial', keyway:'Corbin Russwin A1012-D1', ilco:'A1012-D1', jma:'COR-201', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-d2', cat:'Commercial', keyway:'Corbin Russwin A1012-D2', ilco:'A1012-D2', jma:'COR-202', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-d3', cat:'Commercial', keyway:'Corbin Russwin A1012-D3', ilco:'A1012-D3', jma:'COR-203', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-d4', cat:'Commercial', keyway:'Corbin Russwin A1012-D4', ilco:'A1012-D4', jma:'COR-204', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-d12', cat:'Commercial', keyway:'Corbin Russwin A1012-D12', ilco:'A1012-D12', jma:'COR-205', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-d41', cat:'Commercial', keyway:'Corbin Russwin A1012-D41', ilco:'A1012-D41', jma:'COR-207', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-l1012-d41', cat:'Commercial', keyway:'Corbin Russwin L1012-D41', ilco:'L1012-D41', jma:'COR-214', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-1012-60', cat:'Commercial', keyway:'Corbin Russwin 1012-60', ilco:'1012-60', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-60', cat:'Commercial', keyway:'Corbin Russwin A1012-60', ilco:'A1012-60', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h1', cat:'Commercial', keyway:'Corbin Russwin A1012-H1', ilco:'A1012-H1', jma:'COR-124D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h2', cat:'Commercial', keyway:'Corbin Russwin A1012-H2', ilco:'A1012-H2', jma:'COR-126D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h3', cat:'Commercial', keyway:'Corbin Russwin A1012-H3', ilco:'A1012-H3', jma:'COR-128D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h5', cat:'Commercial', keyway:'Corbin Russwin A1012-H5', ilco:'A1012-H5', jma:'COR-125D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h6', cat:'Commercial', keyway:'Corbin Russwin A1012-H6', ilco:'A1012-H6', jma:'COR-127D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h7', cat:'Commercial', keyway:'Corbin Russwin A1012-H7', ilco:'A1012-H7', jma:'COR-129D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-h8', cat:'Commercial', keyway:'Corbin Russwin A1012-H8', ilco:'A1012-H8', jma:'COR-130D', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59a1', cat:'Commercial', keyway:'Corbin Russwin A1012-59A1', ilco:'A1012-59A1', jma:'COR-179', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59a2', cat:'Commercial', keyway:'Corbin Russwin A1012-59A2', ilco:'A1012-59A2', jma:'COR-180', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59b1', cat:'Commercial', keyway:'Corbin Russwin A1012-59B1', ilco:'A1012-59B1', jma:'COR-181', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59b2', cat:'Commercial', keyway:'Corbin Russwin A1012-59B2', ilco:'A1012-59B2', jma:'COR-182', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59c1', cat:'Commercial', keyway:'Corbin Russwin A1012-59C1', ilco:'A1012-59C1', jma:'COR-183', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59c2', cat:'Commercial', keyway:'Corbin Russwin A1012-59C2', ilco:'A1012-59C2', jma:'COR-184', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59d1', cat:'Commercial', keyway:'Corbin Russwin A1012-59D1', ilco:'A1012-59D1', jma:'COR-185', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59d2', cat:'Commercial', keyway:'Corbin Russwin A1012-59D2', ilco:'A1012-59D2', jma:'COR-186', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59a', cat:'Commercial', keyway:'Corbin Russwin A1012-59A', ilco:'A1012-59A', jma:'COR-187', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59d', cat:'Commercial', keyway:'Corbin Russwin A1012-59D', ilco:'A1012-59D', jma:'COR-190', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59ab', cat:'Commercial', keyway:'Corbin Russwin A1012-59AB', ilco:'A1012-59AB', jma:'COR-191', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59cd', cat:'Commercial', keyway:'Corbin Russwin A1012-59CD', ilco:'A1012-59CD', jma:'COR-192', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-a1012-59ad', cat:'Commercial', keyway:'Corbin Russwin A1012-59AD', ilco:'A1012-59AD', jma:'COR-193', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-cr87', cat:'Commercial', keyway:'Corbin Russwin CR87', ilco:'CR87', jma:'COR-218', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-cr88', cat:'Commercial', keyway:'Corbin Russwin CR88', ilco:'CR88', jma:'COR-216', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-cr89', cat:'Commercial', keyway:'Corbin Russwin CR89', ilco:'CR89', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 230-232.' },
  { id:'cat13-corbin-russwin-cr91', cat:'Commercial', keyway:'Corbin Russwin CR91', ilco:'CR91', jma:'COR-217', cut:'Edge', makes:['Corbin Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 230-232.' },
  { id:'cat13-dexter-master-1054kd', cat:'Commercial', keyway:'Dexter Master 1054KD', ilco:'1054KD', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-a1054kd', cat:'Commercial', keyway:'Dexter Master A1054KD', ilco:'A1054KD', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1054k', cat:'Commercial', keyway:'Dexter Master D1054K', ilco:'D1054K', jma:'DX-5D', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-de6-pc', cat:'Commercial', keyway:'Dexter Master DE6-PC', ilco:'DE6-PC', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1054ka', cat:'Commercial', keyway:'Dexter Master D1054KA', ilco:'D1054KA', jma:'DX-6D', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-md1054k', cat:'Commercial', keyway:'Dexter Master MD1054K', ilco:'MD1054K', jma:'MAS-16D', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1098b', cat:'Commercial', keyway:'Dexter Master D1098B', ilco:'D1098B', jma:'DX-7D', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1098bm', cat:'Commercial', keyway:'Dexter Master D1098BM', ilco:'D1098BM', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1098x', cat:'Commercial', keyway:'Dexter Master D1098X', ilco:'D1098X', jma:'DX-4', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1145', cat:'Commercial', keyway:'Dexter Master D1145', ilco:'D1145', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-d1145a', cat:'Commercial', keyway:'Dexter Master D1145A', ilco:'D1145A', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-ds1145', cat:'Commercial', keyway:'Dexter Master DS1145', ilco:'DS1145', jma:'DX-37', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-ds1145br', cat:'Commercial', keyway:'Dexter Master DS1145BR', ilco:'DS1145BR', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 233-234.' },
  { id:'cat13-dexter-master-dx18r', cat:'Commercial', keyway:'Dexter Master DX18R', ilco:'DX18R', jma:'DX-23', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-dxd3', cat:'Commercial', keyway:'Dexter Master DXD3', ilco:'DXD3', jma:'DX-32', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-dxd4', cat:'Commercial', keyway:'Dexter Master DXD4', ilco:'DXD4', jma:'DX-35', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-dxd30', cat:'Commercial', keyway:'Dexter Master DXD30', ilco:'DXD30', jma:'DX-22', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-dexter-master-dxg5', cat:'Commercial', keyway:'Dexter Master DXG5', ilco:'DXG5', jma:'DX-36', cut:'Edge', makes:['Dexter Master'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 233-234.' },
  { id:'cat13-eagle-lock-1013dl', cat:'Commercial', keyway:'Eagle Lock 1013DL', ilco:'1013DL', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1013f', cat:'Commercial', keyway:'Eagle Lock 1013F', ilco:'1013F', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014', cat:'Commercial', keyway:'Eagle Lock 1014', ilco:'1014', jma:'EAG-6', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014a', cat:'Commercial', keyway:'Eagle Lock 1014A', ilco:'1014A', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014d', cat:'Commercial', keyway:'Eagle Lock 1014D', ilco:'1014D', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014da', cat:'Commercial', keyway:'Eagle Lock 1014DA', ilco:'1014DA', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014k', cat:'Commercial', keyway:'Eagle Lock 1014K', ilco:'1014K', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014ds', cat:'Commercial', keyway:'Eagle Lock 1014DS', ilco:'1014DS', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014dx', cat:'Commercial', keyway:'Eagle Lock 1014DX', ilco:'1014DX', jma:'EAG-5D', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014f', cat:'Commercial', keyway:'Eagle Lock 1014F', ilco:'1014F', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014j', cat:'Commercial', keyway:'Eagle Lock 1014J', ilco:'1014J', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014jm', cat:'Commercial', keyway:'Eagle Lock 1014JM', ilco:'1014JM', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1014jsx', cat:'Commercial', keyway:'Eagle Lock 1014JSX', ilco:'1014JSX', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014js', cat:'Commercial', keyway:'Eagle Lock O1014JS', ilco:'O1014JS', jma:'EAG-2D', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014j', cat:'Commercial', keyway:'Eagle Lock O1014J', ilco:'O1014J', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014jm', cat:'Commercial', keyway:'Eagle Lock O1014JM', ilco:'O1014JM', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014sm', cat:'Commercial', keyway:'Eagle Lock O1014SM', ilco:'O1014SM', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014k', cat:'Commercial', keyway:'Eagle Lock O1014K', ilco:'O1014K', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014p', cat:'Commercial', keyway:'Eagle Lock O1014P', ilco:'O1014P', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-o1014s', cat:'Commercial', keyway:'Eagle Lock O1014S', ilco:'O1014S', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-x1014f', cat:'Commercial', keyway:'Eagle Lock X1014F', ilco:'X1014F', jma:'HAR-1I', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1521', cat:'Commercial', keyway:'Eagle Lock 1521', ilco:'1521', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-eagle-lock-1533', cat:'Commercial', keyway:'Eagle Lock 1533', ilco:'1533', cut:'Edge', makes:['Eagle Lock'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 236-237.' },
  { id:'cat13-falcon-fl1', cat:'Commercial', keyway:'Falcon FL1', ilco:'FL1', jma:'FAL-22D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl2', cat:'Commercial', keyway:'Falcon FL2', ilco:'FL2', jma:'FAL-23D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl3', cat:'Commercial', keyway:'Falcon FL3', ilco:'FL3', jma:'FAL-24D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl4', cat:'Commercial', keyway:'Falcon FL4', ilco:'FL4', jma:'FAL-25D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl5', cat:'Commercial', keyway:'Falcon FL5', ilco:'FL5', jma:'FAL-26D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl5g', cat:'Commercial', keyway:'Falcon FL5G', ilco:'FL5G', jma:'WEI-6', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl6', cat:'Commercial', keyway:'Falcon FL6', ilco:'FL6', jma:'FAL-27D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl7', cat:'Commercial', keyway:'Falcon FL7', ilco:'FL7', jma:'FAL-28D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl8', cat:'Commercial', keyway:'Falcon FL8', ilco:'FL8', jma:'FAL-29D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl9', cat:'Commercial', keyway:'Falcon FL9', ilco:'FL9', jma:'FAL-30D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-fl10', cat:'Commercial', keyway:'Falcon FL10', ilco:'FL10', jma:'FAL-31D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wb', cat:'Commercial', keyway:'Falcon 1054WB', ilco:'1054WB', jma:'WEI-1', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wb', cat:'Commercial', keyway:'Falcon A1054WB', ilco:'A1054WB', jma:'WEI-2', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-l1054wb', cat:'Commercial', keyway:'Falcon L1054WB', ilco:'L1054WB', jma:'WEI-11', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wc', cat:'Commercial', keyway:'Falcon 1054WC', ilco:'1054WC', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wc', cat:'Commercial', keyway:'Falcon A1054WC', ilco:'A1054WC', jma:'WEI-5', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-l1054wc', cat:'Commercial', keyway:'Falcon L1054WC', ilco:'L1054WC', jma:'FAL-10D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wd', cat:'Commercial', keyway:'Falcon 1054WD', ilco:'1054WD', jma:'FAL-13D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wh', cat:'Commercial', keyway:'Falcon 1054WH', ilco:'1054WH', jma:'FAL-14D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wk', cat:'Commercial', keyway:'Falcon 1054WK', ilco:'1054WK', jma:'FAK-15D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wl', cat:'Commercial', keyway:'Falcon 1054WL', ilco:'1054WL', jma:'FAL-16D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wn', cat:'Commercial', keyway:'Falcon 1054WN', ilco:'1054WN', jma:'FAL-17D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wp', cat:'Commercial', keyway:'Falcon 1054WP', ilco:'1054WP', jma:'FAL-18D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wd', cat:'Commercial', keyway:'Falcon A1054WD', ilco:'A1054WD', jma:'FAL-1D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wh', cat:'Commercial', keyway:'Falcon A1054WH', ilco:'A1054WH', jma:'FAL-3D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wk', cat:'Commercial', keyway:'Falcon A1054WK', ilco:'A1054WK', jma:'FAL-4D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wl', cat:'Commercial', keyway:'Falcon A1054WL', ilco:'A1054WL', jma:'FAL-5D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wn', cat:'Commercial', keyway:'Falcon A1054WN', ilco:'A1054WN', jma:'FAL-6D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wp', cat:'Commercial', keyway:'Falcon A1054WP', ilco:'A1054WP', jma:'FAL-7D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-l1054wd', cat:'Commercial', keyway:'Falcon L1054WD', ilco:'L1054WD', jma:'FAL-11D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wf', cat:'Commercial', keyway:'Falcon 1054WF', ilco:'1054WF', jma:'FAL-19D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wj', cat:'Commercial', keyway:'Falcon 1054WJ', ilco:'1054WJ', jma:'FAL-20D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wf', cat:'Commercial', keyway:'Falcon A1054WF', ilco:'A1054WF', jma:'FAL-8D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wj', cat:'Commercial', keyway:'Falcon A1054WJ', ilco:'A1054WJ', jma:'FAL-9D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-1054wr', cat:'Commercial', keyway:'Falcon 1054WR', ilco:'1054WR', jma:'FAL-21D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-falcon-a1054wr', cat:'Commercial', keyway:'Falcon A1054WR', ilco:'A1054WR', jma:'FAL-2D', cut:'Edge', makes:['Falcon'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 238-239.' },
  { id:'cat13-hudson-hl3', cat:'Commercial', keyway:'Hudson HL3', ilco:'HL3', jma:'HUD-10', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-s1000v', cat:'Commercial', keyway:'Hudson S1000V', ilco:'S1000V', jma:'CCL-11', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1000v', cat:'Commercial', keyway:'Hudson 1000V', ilco:'1000V', jma:'CCL-12', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1000x', cat:'Commercial', keyway:'Hudson 1000X', ilco:'1000X', jma:'CCL-5D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1000xk', cat:'Commercial', keyway:'Hudson 1000XK', ilco:'1000XK', jma:'CCL-34D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1003m', cat:'Commercial', keyway:'Hudson 1003M', ilco:'1003M', jma:'HUD-3', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-r1003m', cat:'Commercial', keyway:'Hudson R1003M', ilco:'R1003M', jma:'HUD-3D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1041t', cat:'Commercial', keyway:'Hudson 1041T', ilco:'1041T', jma:'CHI-12D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1069', cat:'Commercial', keyway:'Hudson 1069', ilco:'1069', jma:'HUD-5D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1069b', cat:'Commercial', keyway:'Hudson 1069B', ilco:'1069B', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 242-243.' },
  { id:'cat13-hudson-1098db', cat:'Commercial', keyway:'Hudson 1098DB', ilco:'1098DB', jma:'AMM-4', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1098x', cat:'Commercial', keyway:'Hudson 1098X', ilco:'1098X', jma:'HUD-4', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122', cat:'Commercial', keyway:'Hudson O1122', ilco:'O1122', jma:'YA-44D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122r', cat:'Commercial', keyway:'Hudson O1122R', ilco:'O1122R', jma:'YA-44', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122a', cat:'Commercial', keyway:'Hudson O1122A', ilco:'O1122A', jma:'YA-45D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122ar', cat:'Commercial', keyway:'Hudson O1122AR', ilco:'O1122AR', jma:'YA-45', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122b', cat:'Commercial', keyway:'Hudson O1122B', ilco:'O1122B', jma:'YA-54D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122br', cat:'Commercial', keyway:'Hudson O1122BR', ilco:'O1122BR', jma:'YA-54', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122be', cat:'Commercial', keyway:'Hudson O1122BE', ilco:'O1122BE', jma:'YA-55D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-o1122c', cat:'Commercial', keyway:'Hudson O1122C', ilco:'O1122C', jma:'YA-56D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1561', cat:'Commercial', keyway:'Hudson 1561', ilco:'1561', jma:'HUD-6', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1562', cat:'Commercial', keyway:'Hudson 1562', ilco:'1562', jma:'HUD-7', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1563', cat:'Commercial', keyway:'Hudson 1563', ilco:'1563', jma:'HUD-8D', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1564', cat:'Commercial', keyway:'Hudson 1564', ilco:'1564', jma:'HUD-9', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 242-243.' },
  { id:'cat13-hudson-1525', cat:'Commercial', keyway:'Hudson 1525', ilco:'1525', cut:'Edge', makes:['Hudson'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 242-243.' },
  { id:'cat13-ilco-cylinder-1054', cat:'Commercial', keyway:'Ilco Cylinder 1054', ilco:'1054', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054dl', cat:'Commercial', keyway:'Ilco Cylinder 1054DL', ilco:'1054DL', jma:'ILC-8D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-in35-pc', cat:'Commercial', keyway:'Ilco Cylinder IN35-PC', ilco:'IN35-PC', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054f', cat:'Commercial', keyway:'Ilco Cylinder 1054F', ilco:'1054F', jma:'ILC-16', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054fn', cat:'Commercial', keyway:'Ilco Cylinder 1054FN', ilco:'1054FN', jma:'ILC-5D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054k', cat:'Commercial', keyway:'Ilco Cylinder 1054K', ilco:'1054K', jma:'ILC-1D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054lb', cat:'Commercial', keyway:'Ilco Cylinder 1054LB', ilco:'1054LB', jma:'ILC-6D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054mt', cat:'Commercial', keyway:'Ilco Cylinder 1054MT', ilco:'1054MT', jma:'ILC-2D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054r', cat:'Commercial', keyway:'Ilco Cylinder 1054R', ilco:'1054R', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054n', cat:'Commercial', keyway:'Ilco Cylinder 1054N', ilco:'1054N', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054p', cat:'Commercial', keyway:'Ilco Cylinder 1054P', ilco:'1054P', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054tw', cat:'Commercial', keyway:'Ilco Cylinder 1054TW', ilco:'1054TW', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054un', cat:'Commercial', keyway:'Ilco Cylinder 1054UN', ilco:'1054UN', jma:'ILC-3', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1054x', cat:'Commercial', keyway:'Ilco Cylinder 1054X', ilco:'1054X', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-b1054b', cat:'Commercial', keyway:'Ilco Cylinder B1054B', ilco:'B1054B', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-h1054b', cat:'Commercial', keyway:'Ilco Cylinder H1054B', ilco:'H1054B', jma:'ILC-10D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-h1054s', cat:'Commercial', keyway:'Ilco Cylinder H1054S', ilco:'H1054S', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-h1054l', cat:'Commercial', keyway:'Ilco Cylinder H1054L', ilco:'H1054L', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-k1054b', cat:'Commercial', keyway:'Ilco Cylinder K1054B', ilco:'K1054B', jma:'ILC-9D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-l1054ar', cat:'Commercial', keyway:'Ilco Cylinder L1054AR', ilco:'L1054AR', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-l1054b', cat:'Commercial', keyway:'Ilco Cylinder L1054B', ilco:'L1054B', jma:'ILC-7D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-l1054ja', cat:'Commercial', keyway:'Ilco Cylinder L1054JA', ilco:'L1054JA', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-n1054k', cat:'Commercial', keyway:'Ilco Cylinder N1054K', ilco:'N1054K', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054c', cat:'Commercial', keyway:'Ilco Cylinder X1054C', ilco:'X1054C', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054f', cat:'Commercial', keyway:'Ilco Cylinder X1054F', ilco:'X1054F', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054gc', cat:'Commercial', keyway:'Ilco Cylinder X1054GC', ilco:'X1054GC', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054gd', cat:'Commercial', keyway:'Ilco Cylinder X1054GD', ilco:'X1054GD', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054gf', cat:'Commercial', keyway:'Ilco Cylinder X1054GF', ilco:'X1054GF', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054ja', cat:'Commercial', keyway:'Ilco Cylinder X1054JA', ilco:'X1054JA', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054jk', cat:'Commercial', keyway:'Ilco Cylinder X1054JK', ilco:'X1054JK', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054k', cat:'Commercial', keyway:'Ilco Cylinder X1054K', ilco:'X1054K', jma:'ILC-4D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-x1054sc', cat:'Commercial', keyway:'Ilco Cylinder X1054SC', ilco:'X1054SC', jma:'GLO-9D', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1092tg-ilco', cat:'Commercial', keyway:'Ilco Cylinder 1092TG-ILCO', ilco:'1092TG-ILCO', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1125a', cat:'Commercial', keyway:'Ilco Cylinder 1125A', ilco:'1125A', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1137b', cat:'Commercial', keyway:'Ilco Cylinder 1137B', ilco:'1137B', jma:'CHI-1T', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1154c', cat:'Commercial', keyway:'Ilco Cylinder 1154C', ilco:'1154C', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-ilco-cylinder-1154g', cat:'Commercial', keyway:'Ilco Cylinder 1154G', ilco:'1154G', cut:'Edge', makes:['Ilco Cylinder'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 244-247.' },
  { id:'cat13-illinois-ill1', cat:'Commercial', keyway:'Illinois ILL1', ilco:'ILL1', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-ill2', cat:'Commercial', keyway:'Illinois ILL2', ilco:'ILL2', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1041h', cat:'Commercial', keyway:'Illinois 1041H', ilco:'1041H', jma:'ILL-1', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1041hm', cat:'Commercial', keyway:'Illinois 1041HM', ilco:'1041HM', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1041p', cat:'Commercial', keyway:'Illinois 1041P', ilco:'1041P', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1041s', cat:'Commercial', keyway:'Illinois 1041S', ilco:'1041S', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1041w', cat:'Commercial', keyway:'Illinois 1041W', ilco:'1041W', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-s1041h', cat:'Commercial', keyway:'Illinois S1041H', ilco:'S1041H', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1042a', cat:'Commercial', keyway:'Illinois 1042A', ilco:'1042A', jma:'ILL-5', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1042b', cat:'Commercial', keyway:'Illinois 1042B', ilco:'1042B', jma:'ILL-6', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1042z', cat:'Commercial', keyway:'Illinois 1042Z', ilco:'1042Z', jma:'ILL-9', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-s1042z', cat:'Commercial', keyway:'Illinois S1042Z', ilco:'S1042Z', jma:'ILL-3', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-s1042zm', cat:'Commercial', keyway:'Illinois S1042ZM', ilco:'S1042ZM', jma:'ILL-4', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-s1042zp', cat:'Commercial', keyway:'Illinois S1042ZP', ilco:'S1042ZP', jma:'ILL-8', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-s1042zs', cat:'Commercial', keyway:'Illinois S1042ZS', ilco:'S1042ZS', jma:'ILL-10', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1042wc', cat:'Commercial', keyway:'Illinois 1042WC', ilco:'1042WC', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-l1042a', cat:'Commercial', keyway:'Illinois L1042A', ilco:'L1042A', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-l1042b', cat:'Commercial', keyway:'Illinois L1042B', ilco:'L1042B', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1043b', cat:'Commercial', keyway:'Illinois 1043B', ilco:'1043B', jma:'ILL-2D', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1043c', cat:'Commercial', keyway:'Illinois 1043C', ilco:'1043C', jma:'ILL-2', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1043d', cat:'Commercial', keyway:'Illinois 1043D', ilco:'1043D', jma:'ILL-7', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1043e', cat:'Commercial', keyway:'Illinois 1043E', ilco:'1043E', jma:'ILL-11D', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1043ed', cat:'Commercial', keyway:'Illinois 1043ED', ilco:'1043ED', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1043f', cat:'Commercial', keyway:'Illinois 1043F', ilco:'1043F', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 247-248.' },
  { id:'cat13-illinois-1043g', cat:'Commercial', keyway:'Illinois 1043G', ilco:'1043G', jma:'ILL-12', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-illinois-1043j', cat:'Commercial', keyway:'Illinois 1043J', ilco:'1043J', jma:'TIM-1D', cut:'Edge', makes:['Illinois'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 247-248.' },
  { id:'cat13-lockwood-1004', cat:'Commercial', keyway:'Lockwood 1004', ilco:'1004', jma:'LWO-4D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004a', cat:'Commercial', keyway:'Lockwood 1004A', ilco:'1004A', jma:'LWO-5D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004al', cat:'Commercial', keyway:'Lockwood 1004AL', ilco:'1004AL', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004axm', cat:'Commercial', keyway:'Lockwood 1004AXM', ilco:'1004AXM', jma:'LWO-25D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004kl', cat:'Commercial', keyway:'Lockwood 1004KL', ilco:'1004KL', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004m', cat:'Commercial', keyway:'Lockwood 1004M', ilco:'1004M', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004n', cat:'Commercial', keyway:'Lockwood 1004N', ilco:'1004N', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004r', cat:'Commercial', keyway:'Lockwood 1004R', ilco:'1004R', jma:'LWO-4', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004ar', cat:'Commercial', keyway:'Lockwood 1004AR', ilco:'1004AR', jma:'LWO-5', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-1004sn', cat:'Commercial', keyway:'Lockwood 1004SN', ilco:'1004SN', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-1005', cat:'Commercial', keyway:'Lockwood 1005', ilco:'1005', jma:'YA-22D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-1015', cat:'Commercial', keyway:'Lockwood 1015', ilco:'1015', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-1015c', cat:'Commercial', keyway:'Lockwood 1015C', ilco:'1015C', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015l', cat:'Commercial', keyway:'Lockwood A1015L', ilco:'A1015L', jma:'LWO-10D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015r', cat:'Commercial', keyway:'Lockwood A1015R', ilco:'A1015R', jma:'LWO-14D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015v', cat:'Commercial', keyway:'Lockwood A1015V', ilco:'A1015V', jma:'LWO-18D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015n', cat:'Commercial', keyway:'Lockwood A1015N', ilco:'A1015N', jma:'LWO-11D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015s', cat:'Commercial', keyway:'Lockwood A1015S', ilco:'A1015S', jma:'LWO-15D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015w', cat:'Commercial', keyway:'Lockwood A1015W', ilco:'A1015W', jma:'LWO-19D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015p', cat:'Commercial', keyway:'Lockwood A1015P', ilco:'A1015P', jma:'LWO-12D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015t', cat:'Commercial', keyway:'Lockwood A1015T', ilco:'A1015T', jma:'LWO-16D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015x', cat:'Commercial', keyway:'Lockwood A1015X', ilco:'A1015X', jma:'LWO-20D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015m', cat:'Commercial', keyway:'Lockwood A1015M', ilco:'A1015M', jma:'LWO-3D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015q', cat:'Commercial', keyway:'Lockwood A1015Q', ilco:'A1015Q', jma:'LWO-13D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015u', cat:'Commercial', keyway:'Lockwood A1015U', ilco:'A1015U', jma:'LWO-17D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015y', cat:'Commercial', keyway:'Lockwood A1015Y', ilco:'A1015Y', jma:'LWO-21D', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015lr', cat:'Commercial', keyway:'Lockwood A1015LR', ilco:'A1015LR', jma:'LWO-10', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015rr', cat:'Commercial', keyway:'Lockwood A1015RR', ilco:'A1015RR', jma:'LWO-14', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015vr', cat:'Commercial', keyway:'Lockwood A1015VR', ilco:'A1015VR', jma:'LWO-18', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015nr', cat:'Commercial', keyway:'Lockwood A1015NR', ilco:'A1015NR', jma:'LWO-11', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015sr', cat:'Commercial', keyway:'Lockwood A1015SR', ilco:'A1015SR', jma:'LWO-15', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015wr', cat:'Commercial', keyway:'Lockwood A1015WR', ilco:'A1015WR', jma:'LWO-19', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015pr', cat:'Commercial', keyway:'Lockwood A1015PR', ilco:'A1015PR', jma:'LWO-12', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015tr', cat:'Commercial', keyway:'Lockwood A1015TR', ilco:'A1015TR', jma:'LWO-16', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015xr', cat:'Commercial', keyway:'Lockwood A1015XR', ilco:'A1015XR', jma:'LWO-20', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015mr', cat:'Commercial', keyway:'Lockwood A1015MR', ilco:'A1015MR', jma:'LWO-3', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015qr', cat:'Commercial', keyway:'Lockwood A1015QR', ilco:'A1015QR', jma:'LWO-13', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015ur', cat:'Commercial', keyway:'Lockwood A1015UR', ilco:'A1015UR', jma:'LWO-17', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-a1015yr', cat:'Commercial', keyway:'Lockwood A1015YR', ilco:'A1015YR', jma:'LWO-21', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 249-251.' },
  { id:'cat13-lockwood-l1015m', cat:'Commercial', keyway:'Lockwood L1015M', ilco:'L1015M', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-lockwood-l1015mr', cat:'Commercial', keyway:'Lockwood L1015MR', ilco:'L1015MR', cut:'Edge', makes:['Lockwood'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 249-251.' },
  { id:'cat13-national-cabinet-1064', cat:'Commercial', keyway:'National Cabinet 1064', ilco:'1064', jma:'VI-2I', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1064a', cat:'Commercial', keyway:'National Cabinet 1064A', ilco:'1064A', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1064l', cat:'Commercial', keyway:'National Cabinet 1064L', ilco:'1064L', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1064m', cat:'Commercial', keyway:'National Cabinet 1064M', ilco:'1064M', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-s1064a', cat:'Commercial', keyway:'National Cabinet S1064A', ilco:'S1064A', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1065', cat:'Commercial', keyway:'National Cabinet 1065', ilco:'1065', jma:'VI-1I', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1065c', cat:'Commercial', keyway:'National Cabinet 1065C', ilco:'1065C', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1065d', cat:'Commercial', keyway:'National Cabinet 1065D', ilco:'1065D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1065e', cat:'Commercial', keyway:'National Cabinet 1065E', ilco:'1065E', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1065f', cat:'Commercial', keyway:'National Cabinet 1065F', ilco:'1065F', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069', cat:'Commercial', keyway:'National Cabinet 1069', ilco:'1069', jma:'HUD-5D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069b', cat:'Commercial', keyway:'National Cabinet 1069B', ilco:'1069B', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069c', cat:'Commercial', keyway:'National Cabinet 1069C', ilco:'1069C', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069d', cat:'Commercial', keyway:'National Cabinet 1069D', ilco:'1069D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069e', cat:'Commercial', keyway:'National Cabinet 1069E', ilco:'1069E', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069f', cat:'Commercial', keyway:'National Cabinet 1069F', ilco:'1069F', jma:'NTC-16D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069fna', cat:'Commercial', keyway:'National Cabinet 1069FNA', ilco:'1069FNA', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069fl', cat:'Commercial', keyway:'National Cabinet 1069FL', ilco:'1069FL', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-s1069g', cat:'Commercial', keyway:'National Cabinet S1069G', ilco:'S1069G', jma:'NTC-17D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069g', cat:'Commercial', keyway:'National Cabinet 1069G', ilco:'1069G', jma:'NTC-7D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-s1069h', cat:'Commercial', keyway:'National Cabinet S1069H', ilco:'S1069H', jma:'NTC-18D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069h', cat:'Commercial', keyway:'National Cabinet 1069H', ilco:'1069H', jma:'NTC-8D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069l', cat:'Commercial', keyway:'National Cabinet 1069L', ilco:'1069L', jma:'NTC-1D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-r1069l', cat:'Commercial', keyway:'National Cabinet R1069L', ilco:'R1069L', jma:'NTC-1', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1692', cat:'Commercial', keyway:'National Cabinet 1692', ilco:'1692', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069la', cat:'Commercial', keyway:'National Cabinet 1069LA', ilco:'1069LA', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069lb', cat:'Commercial', keyway:'National Cabinet 1069LB', ilco:'1069LB', jma:'NTR-2D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069lc', cat:'Commercial', keyway:'National Cabinet 1069LC', ilco:'1069LC', jma:'NTR-1D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-s1069m', cat:'Commercial', keyway:'National Cabinet S1069M', ilco:'S1069M', jma:'NTC-19D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069m', cat:'Commercial', keyway:'National Cabinet 1069M', ilco:'1069M', jma:'NTC-9D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069n', cat:'Commercial', keyway:'National Cabinet 1069N', ilco:'1069N', jma:'NTC-10D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069p', cat:'Commercial', keyway:'National Cabinet 1069P', ilco:'1069P', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069s', cat:'Commercial', keyway:'National Cabinet 1069S', ilco:'1069S', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069sm', cat:'Commercial', keyway:'National Cabinet 1069SM', ilco:'1069SM', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-s1069t', cat:'Commercial', keyway:'National Cabinet S1069T', ilco:'S1069T', jma:'NTC-21D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069t', cat:'Commercial', keyway:'National Cabinet 1069T', ilco:'1069T', jma:'NTC-20D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069w', cat:'Commercial', keyway:'National Cabinet 1069W', ilco:'1069W', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069ym', cat:'Commercial', keyway:'National Cabinet 1069YM', ilco:'1069YM', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069-5x', cat:'Commercial', keyway:'National Cabinet 1069-5X', ilco:'1069-5X', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069-5y', cat:'Commercial', keyway:'National Cabinet 1069-5Y', ilco:'1069-5Y', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1069-5z', cat:'Commercial', keyway:'National Cabinet 1069-5Z', ilco:'1069-5Z', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-gf1069', cat:'Commercial', keyway:'National Cabinet GF1069', ilco:'GF1069', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-m1069c', cat:'Commercial', keyway:'National Cabinet M1069C', ilco:'M1069C', jma:'NTC-22D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-m1069l', cat:'Commercial', keyway:'National Cabinet M1069L', ilco:'M1069L', jma:'NTC-23D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-n1069b', cat:'Commercial', keyway:'National Cabinet N1069B', ilco:'N1069B', jma:'NTC-6', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-n1069c', cat:'Commercial', keyway:'National Cabinet N1069C', ilco:'N1069C', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-n1069e', cat:'Commercial', keyway:'National Cabinet N1069E', ilco:'N1069E', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-n1069g', cat:'Commercial', keyway:'National Cabinet N1069G', ilco:'N1069G', jma:'NTC-24D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-n1069j', cat:'Commercial', keyway:'National Cabinet N1069J', ilco:'N1069J', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-n1069n', cat:'Commercial', keyway:'National Cabinet N1069N', ilco:'N1069N', jma:'NTC-15D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1544', cat:'Commercial', keyway:'National Cabinet 1544', ilco:'1544', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1545', cat:'Commercial', keyway:'National Cabinet 1545', ilco:'1545', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-1064d', cat:'Commercial', keyway:'National Cabinet 1064D', ilco:'1064D', jma:'NTL-2', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-r1064d', cat:'Commercial', keyway:'National Cabinet R1064D', ilco:'R1064D', jma:'NTL-2D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-national-cabinet-r1064e', cat:'Commercial', keyway:'National Cabinet R1064E', ilco:'R1064E', jma:'NTL-1D', cut:'Edge', makes:['National Cabinet'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 254-257.' },
  { id:'cat13-russwin-1011', cat:'Commercial', keyway:'Russwin 1011', ilco:'1011', jma:'RUS-7', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011a', cat:'Commercial', keyway:'Russwin 1011A', ilco:'1011A', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1011b', cat:'Commercial', keyway:'Russwin 1011B', ilco:'1011B', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1011gh', cat:'Commercial', keyway:'Russwin 1011GH', ilco:'1011GH', jma:'RUS-75D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011m', cat:'Commercial', keyway:'Russwin 1011M', ilco:'1011M', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1011p', cat:'Commercial', keyway:'Russwin 1011P', ilco:'1011P', jma:'RUS-3', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011paa', cat:'Commercial', keyway:'Russwin 1011PAA', ilco:'1011PAA', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1011s', cat:'Commercial', keyway:'Russwin 1011S', ilco:'1011S', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1011t', cat:'Commercial', keyway:'Russwin 1011T', ilco:'1011T', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1011d1', cat:'Commercial', keyway:'Russwin 1011D1', ilco:'1011D1', jma:'RUS-4', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011d2', cat:'Commercial', keyway:'Russwin 1011D2', ilco:'1011D2', jma:'RUS-30', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011d3', cat:'Commercial', keyway:'Russwin 1011D3', ilco:'1011D3', jma:'RUS-31', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011d4', cat:'Commercial', keyway:'Russwin 1011D4', ilco:'1011D4', jma:'RUS-32', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d1', cat:'Commercial', keyway:'Russwin A1011D1', ilco:'A1011D1', jma:'RUS-5', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d2', cat:'Commercial', keyway:'Russwin A1011D2', ilco:'A1011D2', jma:'RUS-8', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d3', cat:'Commercial', keyway:'Russwin A1011D3', ilco:'A1011D3', jma:'RUS-9', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d4', cat:'Commercial', keyway:'Russwin A1011D4', ilco:'A1011D4', jma:'RUS-10', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d12', cat:'Commercial', keyway:'Russwin A1011D12', ilco:'A1011D12', jma:'RUS-36', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d34', cat:'Commercial', keyway:'Russwin A1011D34', ilco:'A1011D34', jma:'RUS-37', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011d41', cat:'Commercial', keyway:'Russwin 1011D41', ilco:'1011D41', jma:'RUS-35', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011d41', cat:'Commercial', keyway:'Russwin A1011D41', ilco:'A1011D41', jma:'RUS-1', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-b1011d41', cat:'Commercial', keyway:'Russwin B1011D41', ilco:'B1011D41', jma:'RUS-57', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l1', cat:'Commercial', keyway:'Russwin 1011-L1', ilco:'1011-L1', jma:'RUS-4D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l2', cat:'Commercial', keyway:'Russwin 1011-L2', ilco:'1011-L2', jma:'RUS-30D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l3', cat:'Commercial', keyway:'Russwin 1011-L3', ilco:'1011-L3', jma:'RUS-31D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l4', cat:'Commercial', keyway:'Russwin 1011-L4', ilco:'1011-L4', jma:'RUS-32D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l1', cat:'Commercial', keyway:'Russwin A1011-L1', ilco:'A1011-L1', jma:'RUS-5D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l2', cat:'Commercial', keyway:'Russwin A1011-L2', ilco:'A1011-L2', jma:'RUS-8D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l3', cat:'Commercial', keyway:'Russwin A1011-L3', ilco:'A1011-L3', jma:'RUS-9D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l4', cat:'Commercial', keyway:'Russwin A1011-L4', ilco:'A1011-L4', jma:'RUS-14D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-l1011-l4', cat:'Commercial', keyway:'Russwin L1011-L4', ilco:'L1011-L4', jma:'COR-134D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l12', cat:'Commercial', keyway:'Russwin 1011-L12', ilco:'1011-L12', jma:'RUS-33D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l34', cat:'Commercial', keyway:'Russwin 1011-L34', ilco:'1011-L34', jma:'RUS-34D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l12', cat:'Commercial', keyway:'Russwin A1011-L12', ilco:'A1011-L12', jma:'RUS-36D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l34', cat:'Commercial', keyway:'Russwin A1011-L34', ilco:'A1011-L34', jma:'RUS-37D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011-l41', cat:'Commercial', keyway:'Russwin 1011-L41', ilco:'1011-L41', jma:'RUS-35D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011-l41', cat:'Commercial', keyway:'Russwin A1011-L41', ilco:'A1011-L41', jma:'RUS-13D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-l1011-l41', cat:'Commercial', keyway:'Russwin L1011-L41', ilco:'L1011-L41', jma:'COR-137D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-n1011p', cat:'Commercial', keyway:'Russwin N1011P', ilco:'N1011P', jma:'RUS-12', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-n1011s', cat:'Commercial', keyway:'Russwin N1011S', ilco:'N1011S', jma:'RUS-45', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011p', cat:'Commercial', keyway:'Russwin A1011P', ilco:'A1011P', jma:'RUS-6', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011s', cat:'Commercial', keyway:'Russwin A1011S', ilco:'A1011S', jma:'RUS-48', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011t', cat:'Commercial', keyway:'Russwin A1011T', ilco:'A1011T', jma:'RUS-49', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-n1011m', cat:'Commercial', keyway:'Russwin N1011M', ilco:'N1011M', jma:'RUS-47', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011m', cat:'Commercial', keyway:'Russwin A1011M', ilco:'A1011M', jma:'RUS-50', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h1', cat:'Commercial', keyway:'Russwin A1011H1', ilco:'A1011H1', jma:'RUS-38D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h2', cat:'Commercial', keyway:'Russwin A1011H2', ilco:'A1011H2', jma:'RUS-39D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h3', cat:'Commercial', keyway:'Russwin A1011H3', ilco:'A1011H3', jma:'RUS-40D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h5', cat:'Commercial', keyway:'Russwin A1011H5', ilco:'A1011H5', jma:'RUS-41D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h6', cat:'Commercial', keyway:'Russwin A1011H6', ilco:'A1011H6', jma:'RUS-42D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h7', cat:'Commercial', keyway:'Russwin A1011H7', ilco:'A1011H7', jma:'RUS-43D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011h8', cat:'Commercial', keyway:'Russwin A1011H8', ilco:'A1011H8', jma:'RUS-44D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1011pz', cat:'Commercial', keyway:'Russwin 1011PZ', ilco:'1011PZ', jma:'RUS-58D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011pz', cat:'Commercial', keyway:'Russwin A1011PZ', ilco:'A1011PZ', jma:'RUS-11D', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-a1011pzr', cat:'Commercial', keyway:'Russwin A1011PZR', ilco:'A1011PZR', jma:'RUS-11', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 259-264.' },
  { id:'cat13-russwin-1012', cat:'Commercial', keyway:'Russwin 1012', ilco:'1012', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-russwin-1012a', cat:'Commercial', keyway:'Russwin 1012A', ilco:'1012A', cut:'Edge', makes:['Russwin'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 259-264.' },
  { id:'cat13-sargent-1007', cat:'Commercial', keyway:'Sargent 1007', ilco:'1007', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cr', cat:'Commercial', keyway:'Sargent O1007CR', ilco:'O1007CR', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007nb', cat:'Commercial', keyway:'Sargent O1007NB', ilco:'O1007NB', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ca', cat:'Commercial', keyway:'Sargent 1007CA', ilco:'1007CA', jma:'SAR-16', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007cb', cat:'Commercial', keyway:'Sargent 1007CB', ilco:'1007CB', jma:'SAR-17', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007cd', cat:'Commercial', keyway:'Sargent 1007CD', ilco:'1007CD', jma:'SAR-25', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ce', cat:'Commercial', keyway:'Sargent 1007CE', ilco:'1007CE', jma:'SAR-19', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007cf', cat:'Commercial', keyway:'Sargent 1007CF', ilco:'1007CF', jma:'SAR-20', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007cg', cat:'Commercial', keyway:'Sargent 1007CG', ilco:'1007CG', jma:'SAR-21', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007ca', cat:'Commercial', keyway:'Sargent O1007CA', ilco:'O1007CA', jma:'SAR-29', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cb', cat:'Commercial', keyway:'Sargent O1007CB', ilco:'O1007CB', jma:'SAR-30', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cd', cat:'Commercial', keyway:'Sargent O1007CD', ilco:'O1007CD', jma:'SAR-38', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cdh', cat:'Commercial', keyway:'Sargent O1007CDH', ilco:'O1007CDH', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cdm', cat:'Commercial', keyway:'Sargent O1007CDM', ilco:'O1007CDM', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007ce', cat:'Commercial', keyway:'Sargent O1007CE', ilco:'O1007CE', jma:'SAR-32', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cf', cat:'Commercial', keyway:'Sargent O1007CF', ilco:'O1007CF', jma:'SAR-33', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cg', cat:'Commercial', keyway:'Sargent O1007CG', ilco:'O1007CG', jma:'SAR-34', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007ch', cat:'Commercial', keyway:'Sargent O1007CH', ilco:'O1007CH', jma:'SAR-39', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007cn', cat:'Commercial', keyway:'Sargent 1007CN', ilco:'1007CN', jma:'SAR-28', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1007cn', cat:'Commercial', keyway:'Sargent O1007CN', ilco:'O1007CN', jma:'SAR-41', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-l1007cn', cat:'Commercial', keyway:'Sargent L1007CN', ilco:'L1007CN', jma:'SAR-104', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ha', cat:'Commercial', keyway:'Sargent 1007HA', ilco:'1007HA', jma:'SAR-42', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hb', cat:'Commercial', keyway:'Sargent 1007HB', ilco:'1007HB', jma:'SAR-43', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hc', cat:'Commercial', keyway:'Sargent 1007HC', ilco:'1007HC', jma:'SAR-44', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hd', cat:'Commercial', keyway:'Sargent 1007HD', ilco:'1007HD', jma:'SAR-51', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hdh', cat:'Commercial', keyway:'Sargent 1007HDH', ilco:'1007HDH', jma:'SAR-54', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007he', cat:'Commercial', keyway:'Sargent 1007HE', ilco:'1007HE', jma:'SAR-45', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hf', cat:'Commercial', keyway:'Sargent 1007HF', ilco:'1007HF', jma:'SAR-46', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hg', cat:'Commercial', keyway:'Sargent 1007HG', ilco:'1007HG', jma:'SAR-47', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hh', cat:'Commercial', keyway:'Sargent 1007HH', ilco:'1007HH', jma:'SAR-52', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hj', cat:'Commercial', keyway:'Sargent 1007HJ', ilco:'1007HJ', jma:'SAR-48', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hk', cat:'Commercial', keyway:'Sargent 1007HK', ilco:'1007HK', jma:'SAR-49', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hl', cat:'Commercial', keyway:'Sargent 1007HL', ilco:'1007HL', jma:'SAR-50', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hm', cat:'Commercial', keyway:'Sargent 1007HM', ilco:'1007HM', jma:'SAR-53', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007hn', cat:'Commercial', keyway:'Sargent 1007HN', ilco:'1007HN', jma:'SAR-55', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007la', cat:'Commercial', keyway:'Sargent 1007LA', ilco:'1007LA', jma:'SAR-8', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lb', cat:'Commercial', keyway:'Sargent 1007LB', ilco:'1007LB', jma:'SAR-69', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lc', cat:'Commercial', keyway:'Sargent 1007LC', ilco:'1007LC', jma:'SAR-70', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ld', cat:'Commercial', keyway:'Sargent 1007LD', ilco:'1007LD', jma:'SAR-77', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ldh', cat:'Commercial', keyway:'Sargent 1007LDH', ilco:'1007LDH', jma:'SAR-80', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ldm', cat:'Commercial', keyway:'Sargent 1007LDM', ilco:'1007LDM', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1007le', cat:'Commercial', keyway:'Sargent 1007LE', ilco:'1007LE', jma:'SAR-71', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lf', cat:'Commercial', keyway:'Sargent 1007LF', ilco:'1007LF', jma:'SAR-72', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lg', cat:'Commercial', keyway:'Sargent 1007LG', ilco:'1007LG', jma:'SAR-73', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lh', cat:'Commercial', keyway:'Sargent 1007LH', ilco:'1007LH', jma:'SAR-78', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lhm', cat:'Commercial', keyway:'Sargent 1007LHM', ilco:'1007LHM', jma:'SAR-81', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lj', cat:'Commercial', keyway:'Sargent 1007LJ', ilco:'1007LJ', jma:'SAR-74', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lk', cat:'Commercial', keyway:'Sargent 1007LK', ilco:'1007LK', jma:'SAR-75', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ll', cat:'Commercial', keyway:'Sargent 1007LL', ilco:'1007LL', jma:'SAR-76', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007lm', cat:'Commercial', keyway:'Sargent 1007LM', ilco:'1007LM', jma:'SAR-79', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007ra', cat:'Commercial', keyway:'Sargent 1007RA', ilco:'1007RA', jma:'SAR-8D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rb', cat:'Commercial', keyway:'Sargent 1007RB', ilco:'1007RB', jma:'SAR-69D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rc', cat:'Commercial', keyway:'Sargent 1007RC', ilco:'1007RC', jma:'SAR-70D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rd', cat:'Commercial', keyway:'Sargent 1007RD', ilco:'1007RD', jma:'SAR-77D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rdh', cat:'Commercial', keyway:'Sargent 1007RDH', ilco:'1007RDH', jma:'SAR-80D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rdm', cat:'Commercial', keyway:'Sargent 1007RDM', ilco:'1007RDM', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1007re', cat:'Commercial', keyway:'Sargent 1007RE', ilco:'1007RE', jma:'SAR-71D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rf', cat:'Commercial', keyway:'Sargent 1007RF', ilco:'1007RF', jma:'SAR-72D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rg', cat:'Commercial', keyway:'Sargent 1007RG', ilco:'1007RG', jma:'SAR-73D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rh', cat:'Commercial', keyway:'Sargent 1007RH', ilco:'1007RH', jma:'SAR-78D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rhm', cat:'Commercial', keyway:'Sargent 1007RHM', ilco:'1007RHM', jma:'SAR-81D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rj', cat:'Commercial', keyway:'Sargent 1007RJ', ilco:'1007RJ', jma:'SAR-74D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rk', cat:'Commercial', keyway:'Sargent 1007RK', ilco:'1007RK', jma:'SAR-75D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rl', cat:'Commercial', keyway:'Sargent 1007RL', ilco:'1007RL', jma:'SAR-76D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1007rm', cat:'Commercial', keyway:'Sargent 1007RM', ilco:'1007RM', jma:'SAR-79D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1008', cat:'Commercial', keyway:'Sargent 1008', ilco:'1008', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1009', cat:'Commercial', keyway:'Sargent 1009', ilco:'1009', jma:'PR-6', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1009a', cat:'Commercial', keyway:'Sargent 1009A', ilco:'1009A', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1009m', cat:'Commercial', keyway:'Sargent 1009M', ilco:'1009M', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-o1009', cat:'Commercial', keyway:'Sargent O1009', ilco:'O1009', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1010', cat:'Commercial', keyway:'Sargent 1010', ilco:'1010', jma:'KEI-1', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1010a', cat:'Commercial', keyway:'Sargent 1010A', ilco:'1010A', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1010b', cat:'Commercial', keyway:'Sargent 1010B', ilco:'1010B', jma:'SAR-4D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1010m', cat:'Commercial', keyway:'Sargent 1010M', ilco:'1010M', jma:'SAR-119D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1010s', cat:'Commercial', keyway:'Sargent 1010S', ilco:'1010S', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-1010n', cat:'Commercial', keyway:'Sargent 1010N', ilco:'1010N', jma:'SAR-2D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-l1010n', cat:'Commercial', keyway:'Sargent L1010N', ilco:'L1010N', jma:'SAR-9D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-1010u', cat:'Commercial', keyway:'Sargent 1010U', ilco:'1010U', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-a1010u', cat:'Commercial', keyway:'Sargent A1010U', ilco:'A1010U', jma:'SAR-14D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1010', cat:'Commercial', keyway:'Sargent O1010', ilco:'O1010', jma:'SAR-5D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-o1010a', cat:'Commercial', keyway:'Sargent O1010A', ilco:'O1010A', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-s6', cat:'Commercial', keyway:'Sargent S6', ilco:'S6', jma:'SAR-1', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-s16', cat:'Commercial', keyway:'Sargent S16', ilco:'S16', jma:'SAR-6', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-s31', cat:'Commercial', keyway:'Sargent S31', ilco:'S31', jma:'SAR-1D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-s32', cat:'Commercial', keyway:'Sargent S32', ilco:'S32', jma:'SAR-6D', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 264-270.' },
  { id:'cat13-sargent-s70', cat:'Commercial', keyway:'Sargent S70', ilco:'S70', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-s73', cat:'Commercial', keyway:'Sargent S73', ilco:'S73', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-sargent-o1054a', cat:'Commercial', keyway:'Sargent O1054A', ilco:'O1054A', cut:'Edge', makes:['Sargent'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 264-270.' },
  { id:'cat13-schlage-sc1246', cat:'Commercial', keyway:'Schlage SC1246', ilco:'SC1246', jma:'SLG-29', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1247', cat:'Commercial', keyway:'Schlage SC1247', ilco:'SC1247', jma:'SLG-30', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1248', cat:'Commercial', keyway:'Schlage SC1248', ilco:'SC1248', jma:'SLG-31', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1340', cat:'Commercial', keyway:'Schlage SC1340', ilco:'SC1340', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1345', cat:'Commercial', keyway:'Schlage SC1345', ilco:'SC1345', jma:'SLG-32', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1347', cat:'Commercial', keyway:'Schlage SC1347', ilco:'SC1347', jma:'SLG-33', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1368', cat:'Commercial', keyway:'Schlage SC1368', ilco:'SC1368', jma:'SLG-35', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1400', cat:'Commercial', keyway:'Schlage SC1400', ilco:'SC1400', jma:'SLG-36', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1456', cat:'Commercial', keyway:'Schlage SC1456', ilco:'SC1456', jma:'SLG-37', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1460', cat:'Commercial', keyway:'Schlage SC1460', ilco:'SC1460', jma:'SLG-38', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1467', cat:'Commercial', keyway:'Schlage SC1467', ilco:'SC1467', jma:'SLG-39', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1468', cat:'Commercial', keyway:'Schlage SC1468', ilco:'SC1468', jma:'SLG-40', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-101c-ns-dnd', cat:'Commercial', keyway:'Schlage 101C-NS-DND', ilco:'101C-NS-DND', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-101e-ns-dnd', cat:'Commercial', keyway:'Schlage 101E-NS-DND', ilco:'101E-NS-DND', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-101-c-lfic', cat:'Commercial', keyway:'Schlage 101-C-LFIC', ilco:'101-C-LFIC', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-101-e-lfic', cat:'Commercial', keyway:'Schlage 101-E-LFIC', ilco:'101-E-LFIC', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-c123', cat:'Commercial', keyway:'Schlage C123', ilco:'C123', jma:'SLG-42DS', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-c145', cat:'Commercial', keyway:'Schlage C145', ilco:'C145', jma:'SLG-43DS', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1-big', cat:'Commercial', keyway:'Schlage SC1-BIG', ilco:'SC1-BIG', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-1307a', cat:'Commercial', keyway:'Schlage 1307A', ilco:'1307A', jma:'SLG-1', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-l1307a', cat:'Commercial', keyway:'Schlage L1307A', ilco:'L1307A', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-r1307a', cat:'Commercial', keyway:'Schlage R1307A', ilco:'R1307A', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-1307w', cat:'Commercial', keyway:'Schlage 1307W', ilco:'1307W', jma:'SLG-2', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145', cat:'Commercial', keyway:'Schlage 1145', ilco:'1145', jma:'SLG-3', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145a', cat:'Commercial', keyway:'Schlage 1145A', ilco:'1145A', jma:'SLG-4', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145ce', cat:'Commercial', keyway:'Schlage 1145CE', ilco:'1145CE', jma:'SLG-13', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145ce', cat:'Commercial', keyway:'Schlage A1145CE', ilco:'A1145CE', jma:'SLG-8', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145e', cat:'Commercial', keyway:'Schlage 1145E', ilco:'1145E', jma:'SLG-11', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145e', cat:'Commercial', keyway:'Schlage A1145E', ilco:'A1145E', jma:'SLG-5', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145ef', cat:'Commercial', keyway:'Schlage 1145EF', ilco:'1145EF', jma:'SLG-15', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145ef', cat:'Commercial', keyway:'Schlage A1145EF', ilco:'A1145EF', jma:'SLG-10', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145f', cat:'Commercial', keyway:'Schlage 1145F', ilco:'1145F', jma:'SLG-12', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145f', cat:'Commercial', keyway:'Schlage A1145F', ilco:'A1145F', jma:'SLG-9', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145fg', cat:'Commercial', keyway:'Schlage 1145FG', ilco:'1145FG', jma:'SLG-21', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145fg', cat:'Commercial', keyway:'Schlage A1145FG', ilco:'A1145FG', jma:'SLG-19', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145g', cat:'Commercial', keyway:'Schlage 1145G', ilco:'1145G', jma:'SLG-22', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145g', cat:'Commercial', keyway:'Schlage A1145G', ilco:'A1145G', jma:'SLG-18', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145h', cat:'Commercial', keyway:'Schlage 1145H', ilco:'1145H', jma:'SLG-23', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145h', cat:'Commercial', keyway:'Schlage A1145H', ilco:'A1145H', jma:'SLG-16', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145j', cat:'Commercial', keyway:'Schlage 1145J', ilco:'1145J', jma:'SLG-24', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145j', cat:'Commercial', keyway:'Schlage A1145J', ilco:'A1145J', jma:'SLG-17', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145k', cat:'Commercial', keyway:'Schlage 1145K', ilco:'1145K', jma:'SLG-25', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145k', cat:'Commercial', keyway:'Schlage A1145K', ilco:'A1145K', jma:'SLG-20', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-1145l', cat:'Commercial', keyway:'Schlage 1145L', ilco:'1145L', jma:'SLG-14', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-a1145l', cat:'Commercial', keyway:'Schlage A1145L', ilco:'A1145L', jma:'SLG-6', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 270-272.' },
  { id:'cat13-schlage-sc1-pc', cat:'Commercial', keyway:'Schlage SC1-PC', ilco:'SC1-PC', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-l1307w', cat:'Commercial', keyway:'Schlage L1307W', ilco:'L1307W', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-schlage-r1307w', cat:'Commercial', keyway:'Schlage R1307W', ilco:'R1307W', cut:'Edge', makes:['Schlage'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 270-272.' },
  { id:'cat13-yale-y8', cat:'Commercial', keyway:'Yale Y8', ilco:'Y8', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-d9', cat:'Commercial', keyway:'Yale D9', ilco:'D9', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-sx9b', cat:'Commercial', keyway:'Yale SX9B', ilco:'SX9B', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-y204', cat:'Commercial', keyway:'Yale Y204', ilco:'Y204', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-889a', cat:'Commercial', keyway:'Yale 889A', ilco:'889A', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-994arm', cat:'Commercial', keyway:'Yale 994ARM', ilco:'994ARM', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-994m', cat:'Commercial', keyway:'Yale 994M', ilco:'994M', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-y200', cat:'Commercial', keyway:'Yale Y200', ilco:'Y200', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997a', cat:'Commercial', keyway:'Yale 997A', ilco:'997A', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997b', cat:'Commercial', keyway:'Yale 997B', ilco:'997B', jma:'YA-7D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997db', cat:'Commercial', keyway:'Yale 997DB', ilco:'997DB', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997d', cat:'Commercial', keyway:'Yale 997D', ilco:'997D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997da', cat:'Commercial', keyway:'Yale 997DA', ilco:'997DA', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-r997da', cat:'Commercial', keyway:'Yale R997DA', ilco:'R997DA', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997eb', cat:'Commercial', keyway:'Yale 997EB', ilco:'997EB', jma:'YA-63D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997e', cat:'Commercial', keyway:'Yale 997E', ilco:'997E', jma:'YA-13D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997g', cat:'Commercial', keyway:'Yale 997G', ilco:'997G', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997gr', cat:'Commercial', keyway:'Yale 997GR', ilco:'997GR', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997gx', cat:'Commercial', keyway:'Yale 997GX', ilco:'997GX', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997ja', cat:'Commercial', keyway:'Yale 997JA', ilco:'997JA', jma:'YA-248D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997jb', cat:'Commercial', keyway:'Yale 997JB', ilco:'997JB', jma:'YA-249D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997jc', cat:'Commercial', keyway:'Yale 997JC', ilco:'997JC', jma:'YA-250D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997jd', cat:'Commercial', keyway:'Yale 997JD', ilco:'997JD', jma:'YA-251D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997je', cat:'Commercial', keyway:'Yale 997JE', ilco:'997JE', jma:'YA-252D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997jf', cat:'Commercial', keyway:'Yale 997JF', ilco:'997JF', jma:'YA-253D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997l', cat:'Commercial', keyway:'Yale 997L', ilco:'997L', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997la', cat:'Commercial', keyway:'Yale 997LA', ilco:'997LA', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997pa', cat:'Commercial', keyway:'Yale 997PA', ilco:'997PA', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-997x', cat:'Commercial', keyway:'Yale 997X', ilco:'997X', jma:'YA-82D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h997eb', cat:'Commercial', keyway:'Yale H997EB', ilco:'H997EB', jma:'YA-33D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h997e', cat:'Commercial', keyway:'Yale H997E', ilco:'H997E', jma:'YA-3D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h997er', cat:'Commercial', keyway:'Yale H997ER', ilco:'H997ER', jma:'YA-3I', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-j997m', cat:'Commercial', keyway:'Yale J997M', ilco:'J997M', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-j997mr', cat:'Commercial', keyway:'Yale J997MR', ilco:'J997MR', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-998r', cat:'Commercial', keyway:'Yale 998R', ilco:'998R', jma:'YA-80', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h998r', cat:'Commercial', keyway:'Yale H998R', ilco:'H998R', jma:'YA-165', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998va', cat:'Commercial', keyway:'Yale 998VA', ilco:'998VA', jma:'YA-57', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998vb', cat:'Commercial', keyway:'Yale 998VB', ilco:'998VB', jma:'YA-58', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998vc', cat:'Commercial', keyway:'Yale 998VC', ilco:'998VC', jma:'YA-59', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998vd', cat:'Commercial', keyway:'Yale 998VD', ilco:'998VD', jma:'YA-91', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998ve', cat:'Commercial', keyway:'Yale 998VE', ilco:'998VE', jma:'YA-92', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998vf', cat:'Commercial', keyway:'Yale 998VF', ilco:'998VF', jma:'YA-93', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998vg', cat:'Commercial', keyway:'Yale 998VG', ilco:'998VG', jma:'YA-94', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998ya', cat:'Commercial', keyway:'Yale 998YA', ilco:'998YA', jma:'YA-107', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998yb', cat:'Commercial', keyway:'Yale 998YB', ilco:'998YB', jma:'YA-108', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998yc', cat:'Commercial', keyway:'Yale 998YC', ilco:'998YC', jma:'YA.109', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998yd', cat:'Commercial', keyway:'Yale 998YD', ilco:'998YD', jma:'YA-110', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998ye', cat:'Commercial', keyway:'Yale 998YE', ilco:'998YE', jma:'YA-111', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998yg', cat:'Commercial', keyway:'Yale 998YG', ilco:'998YG', jma:'YA-113', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998yh', cat:'Commercial', keyway:'Yale 998YH', ilco:'998YH', jma:'YA-114', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998ymk', cat:'Commercial', keyway:'Yale 998YMK', ilco:'998YMK', jma:'YA-116', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h998ymk', cat:'Commercial', keyway:'Yale H998YMK', ilco:'H998YMK', jma:'YA-155', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-b997eh', cat:'Commercial', keyway:'Yale B997EH', ilco:'B997EH', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-o997e', cat:'Commercial', keyway:'Yale O997E', ilco:'O997E', jma:'YA-25D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o997er', cat:'Commercial', keyway:'Yale O997ER', ilco:'O997ER', jma:'YA-25I', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o997g', cat:'Commercial', keyway:'Yale O997G', ilco:'O997G', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-r997eb', cat:'Commercial', keyway:'Yale R997EB', ilco:'R997EB', jma:'YA-7I', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-997er', cat:'Commercial', keyway:'Yale 997ER', ilco:'997ER', jma:'YA-13I', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998gst', cat:'Commercial', keyway:'Yale 998GST', ilco:'998GST', jma:'YA-64D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-a998gst', cat:'Commercial', keyway:'Yale A998GST', ilco:'A998GST', jma:'YA-238D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998la', cat:'Commercial', keyway:'Yale 998LA', ilco:'998LA', jma:'YA-97D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998lb', cat:'Commercial', keyway:'Yale 998LB', ilco:'998LB', jma:'YA-98D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998lc', cat:'Commercial', keyway:'Yale 998LC', ilco:'998LC', jma:'YA-99D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998ld', cat:'Commercial', keyway:'Yale 998LD', ilco:'998LD', jma:'YA-100D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998le', cat:'Commercial', keyway:'Yale 998LE', ilco:'998LE', jma:'YA-101D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998lf', cat:'Commercial', keyway:'Yale 998LF', ilco:'998LF', jma:'YA-102D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998lg', cat:'Commercial', keyway:'Yale 998LG', ilco:'998LG', jma:'YA-103D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998gl', cat:'Commercial', keyway:'Yale 998GL', ilco:'998GL', jma:'YA-106D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sa', cat:'Commercial', keyway:'Yale 998SA', ilco:'998SA', jma:'YA-117D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sb', cat:'Commercial', keyway:'Yale 998SB', ilco:'998SB', jma:'YA-118D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sc', cat:'Commercial', keyway:'Yale 998SC', ilco:'998SC', jma:'YA-119D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sd', cat:'Commercial', keyway:'Yale 998SD', ilco:'998SD', jma:'YA-120D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998se', cat:'Commercial', keyway:'Yale 998SE', ilco:'998SE', jma:'YA-121D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sf', cat:'Commercial', keyway:'Yale 998SF', ilco:'998SF', jma:'YA-122D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sg', cat:'Commercial', keyway:'Yale 998SG', ilco:'998SG', jma:'YA-123D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sh', cat:'Commercial', keyway:'Yale 998SH', ilco:'998SH', jma:'YA-124D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998smk', cat:'Commercial', keyway:'Yale 998SMK', ilco:'998SMK', jma:'YA-126D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h998smk', cat:'Commercial', keyway:'Yale H998SMK', ilco:'H998SMK', jma:'YA-185D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998ta', cat:'Commercial', keyway:'Yale 998TA', ilco:'998TA', jma:'YA-127D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998tb', cat:'Commercial', keyway:'Yale 998TB', ilco:'998TB', jma:'YA-128D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998td', cat:'Commercial', keyway:'Yale 998TD', ilco:'998TD', jma:'YA-130D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998te', cat:'Commercial', keyway:'Yale 998TE', ilco:'998TE', jma:'YA-131D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998tf', cat:'Commercial', keyway:'Yale 998TF', ilco:'998TF', jma:'YA-132D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998tg', cat:'Commercial', keyway:'Yale 998TG', ilco:'998TG', jma:'YA-133D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998th', cat:'Commercial', keyway:'Yale 998TH', ilco:'998TH', jma:'YA-134D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998tmk', cat:'Commercial', keyway:'Yale 998TMK', ilco:'998TMK', jma:'YA-136D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h998tmk', cat:'Commercial', keyway:'Yale H998TMK', ilco:'H998TMK', jma:'YA-175D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-998sv', cat:'Commercial', keyway:'Yale 998SV', ilco:'998SV', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-999', cat:'Commercial', keyway:'Yale 999', ilco:'999', jma:'YA-41D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-999a', cat:'Commercial', keyway:'Yale 999A', ilco:'999A', jma:'YA-17D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-999b', cat:'Commercial', keyway:'Yale 999B', ilco:'999B', jma:'YO-60D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-y1-pc', cat:'Commercial', keyway:'Yale Y1-PC', ilco:'Y1-PC', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-999ca', cat:'Commercial', keyway:'Yale 999CA', ilco:'999CA', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-y202', cat:'Commercial', keyway:'Yale Y202', ilco:'Y202', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-999n', cat:'Commercial', keyway:'Yale 999N', ilco:'999N', jma:'YA-34D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-999r', cat:'Commercial', keyway:'Yale 999R', ilco:'999R', jma:'YA-41', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-999u', cat:'Commercial', keyway:'Yale 999U', ilco:'999U', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-999k1', cat:'Commercial', keyway:'Yale 999K1', ilco:'999K1', jma:'TE-17D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-999k2', cat:'Commercial', keyway:'Yale 999K2', ilco:'999K2', jma:'TE-11D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-999k3', cat:'Commercial', keyway:'Yale 999K3', ilco:'999K3', jma:'TE-15D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-c999', cat:'Commercial', keyway:'Yale C999', ilco:'C999', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-h999', cat:'Commercial', keyway:'Yale H999', ilco:'H999', jma:'YA-1D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-h999r', cat:'Commercial', keyway:'Yale H999R', ilco:'H999R', jma:'YA-1I', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-x999', cat:'Commercial', keyway:'Yale X999', ilco:'X999', jma:'YA-6D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-1122d', cat:'Commercial', keyway:'Yale 1122D', ilco:'1122D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-f1122a', cat:'Commercial', keyway:'Yale F1122A', ilco:'F1122A', jma:'YA-8D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-f1122ar', cat:'Commercial', keyway:'Yale F1122AR', ilco:'F1122AR', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-h1122f', cat:'Commercial', keyway:'Yale H1122F', ilco:'H1122F', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-h1122fr', cat:'Commercial', keyway:'Yale H1122FR', ilco:'H1122FR', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-h1122w', cat:'Commercial', keyway:'Yale H1122W', ilco:'H1122W', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-l1122a', cat:'Commercial', keyway:'Yale L1122A', ilco:'L1122A', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-l1122ar', cat:'Commercial', keyway:'Yale L1122AR', ilco:'L1122AR', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-o1122', cat:'Commercial', keyway:'Yale O1122', ilco:'O1122', jma:'YA-44D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122r', cat:'Commercial', keyway:'Yale O1122R', ilco:'O1122R', jma:'YA-44', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122a', cat:'Commercial', keyway:'Yale O1122A', ilco:'O1122A', jma:'YA-45D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122ar', cat:'Commercial', keyway:'Yale O1122AR', ilco:'O1122AR', jma:'YA-45', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122b', cat:'Commercial', keyway:'Yale O1122B', ilco:'O1122B', jma:'YA-54D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122br', cat:'Commercial', keyway:'Yale O1122BR', ilco:'O1122BR', jma:'YA-54', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122be', cat:'Commercial', keyway:'Yale O1122BE', ilco:'O1122BE', jma:'YA-55D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122ber', cat:'Commercial', keyway:'Yale O1122BER', ilco:'O1122BER', jma:'YA-55', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-o1122c', cat:'Commercial', keyway:'Yale O1122C', ilco:'O1122C', jma:'YA-56D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-1132', cat:'Commercial', keyway:'Yale 1132', ilco:'1132', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
  { id:'cat13-yale-h1132', cat:'Commercial', keyway:'Yale H1132', ilco:'H1132', jma:'YA-5D', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13; JMA Keys Catalogue MX C13 competitor cross-reference; section 2, pages 276-282.' },
  { id:'cat13-yale-1587', cat:'Commercial', keyway:'Yale 1587', ilco:'1587', cut:'Edge', makes:['Yale'], notes:'Ilco Key Blank Directory, edition 13, section 2, pages 276-282.' },
];
